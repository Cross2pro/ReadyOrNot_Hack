...
public:
	...
	uint8                                        Pad_9D[0x18];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_115[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_116[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_12D[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C9[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1E9[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_20A[0xE0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_234[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
