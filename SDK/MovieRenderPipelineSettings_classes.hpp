...
public:
	...
	uint8                                        Pad_1282[0x2F];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	TArray<TScriptInterface<class IMovieSceneConsoleVariableTrackInterface>> ConsoleVariablePresets;                            // 0x48(0x10)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TMap<class FString, float>                   ConsoleVariables;                                  // 0x58(0x50)(Deprecated, NativeAccessSpecifierPublic)
	TArray<class FString>                        StartConsoleCommands;                              // 0xA8(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                        EndConsoleCommands;                                // 0xB8(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FMoviePipelineConsoleVariableEntry> CVars;                                             // 0xC8(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_13BA[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13F0[0x17];                                    // Fixing Size After Last Property  [ Dumper-7 ]
