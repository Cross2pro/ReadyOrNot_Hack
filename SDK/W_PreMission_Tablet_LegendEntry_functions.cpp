...
void UW_PreMission_Tablet_LegendEntry_C::ExecuteUbergraph_W_PreMission_Tablet_LegendEntry(int32 EntryPoint, class UW_PreMission_Tablet_MapMarker_C* CallFunc_Create_ReturnValue, class UW_OfficerMarker_C* CallFunc_Create_ReturnValue_1, const struct FMargin& K2Node_MakeStruct_Margin, bool K2Node_Event_IsDesignTime, const struct FPlanningMarker& K2Node_MakeStruct_PlanningMarker, class UPanelSlot* CallFunc_AddChild_ReturnValue, bool CallFunc_NotEqual_NameName_ReturnValue, class USizeBoxSlot* CallFunc_SlotAsSizeBoxSlot_ReturnValue, class UPanelSlot* CallFunc_AddChild_ReturnValue_1, float K2Node_MakeStruct_Rotation_ImplicitCast)
{
	static class UFunction* Func = nullptr;
