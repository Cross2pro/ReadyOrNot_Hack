...
// float                              CallFunc_GetStressUntilWeaponRaise_ReturnValue                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
bool UAG_ReachedStressUntilWeaponRaise_C::CanOpen(struct FAIActionDecisionContext& Context, class ACyberneticCharacter* CallFunc_GetCharacter_ReturnValue, float CallFunc_GetStressUntilWeaponRaise_ReturnValue, bool CallFunc_Greater_DoubleDouble_ReturnValue, double CallFunc_Greater_DoubleDouble_A_ImplicitCast, double CallFunc_Greater_DoubleDouble_B_ImplicitCast)
{
	...
	Parms.CallFunc_GetStressUntilWeaponRaise_ReturnValue = CallFunc_GetStressUntilWeaponRaise_ReturnValue;
