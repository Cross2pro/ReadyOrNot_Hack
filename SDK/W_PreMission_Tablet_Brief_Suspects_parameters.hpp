...
struct UW_PreMission_Tablet_Brief_Suspects_C_BP_GetDesiredFocusTarget_Params
{
public:
...
struct UW_PreMission_Tablet_Brief_Suspects_C_OnAnalogValueChanged_Params
{
public:
...
struct UW_PreMission_Tablet_Brief_Suspects_C_PopulateSuspects_Params
{
public:
	...
	struct FCharacterBio                         CallFunc_Array_Get_Item;                           // 0x38(0x148)(None)
	bool                                         CallFunc_Less_IntInt_ReturnValue;                  // 0x180(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Array_IsValidIndex_ReturnValue;           // 0x181(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
