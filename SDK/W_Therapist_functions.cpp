...
// class UW_Therapist_OfficerEntry_C* NewEntryWidget                                                   (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UW_Therapist_OfficerEntry_C* CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_BackPage_Handled                                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UW_Therapist_OfficerEntry_C* K2Node_CustomEvent_Entry                                         (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
