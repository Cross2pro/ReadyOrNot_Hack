...
{
public:
	TArray<TScriptInterface<class IIRadioWidget_C>> RadioChildren;                                     // 0x1A8(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)
	TScriptInterface<class IIRadioWidget_C>      SelectedChild;                                     // 0x1B8(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
