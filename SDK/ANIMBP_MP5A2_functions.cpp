...
class UClass* UANIMBP_MP5A2_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ANIMBP_MP5A2_C");

	return Clss;
}


// ANIMBP_MP5A2_C ANIMBP_MP5A2.Default__ANIMBP_MP5A2_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UANIMBP_MP5A2_C* UANIMBP_MP5A2_C::GetDefaultObj()
{
	static class UANIMBP_MP5A2_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UANIMBP_MP5A2_C*>(UANIMBP_MP5A2_C::StaticClass()->DefaultObject);
...
void UANIMBP_MP5A2_C::AnimGraph(struct FPoseLink* AnimGraph)
{
	...
	Params::UANIMBP_MP5A2_C_AnimGraph_Params Parms{};
...
void UANIMBP_MP5A2_C::BlueprintUpdateAnimation(float DeltaTimeX)
{
	...
	Params::UANIMBP_MP5A2_C_BlueprintUpdateAnimation_Params Parms{};
...
void UANIMBP_MP5A2_C::ExecuteUbergraph_ANIMBP_MP5A2(int32 EntryPoint, float K2Node_Event_DeltaTimeX, class AActor* CallFunc_GetOwningActor_ReturnValue, class ABaseMagazineWeapon* K2Node_DynamicCast_AsBase_Magazine_Weapon, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::UANIMBP_MP5A2_C_ExecuteUbergraph_ANIMBP_MP5A2_Params Parms{};
