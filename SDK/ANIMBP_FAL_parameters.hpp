...
struct UANIMBP_FAL_C_AnimGraph_Params
{
public:
...
struct UANIMBP_FAL_C_BlueprintUpdateAnimation_Params
{
public:
...
struct UANIMBP_FAL_C_ExecuteUbergraph_ANIMBP_FAL_Params
{
public:
	...
	uint8                                        Pad_35B1[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	double                                       CallFunc_FTrunc_A_ImplicitCast;                    // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
