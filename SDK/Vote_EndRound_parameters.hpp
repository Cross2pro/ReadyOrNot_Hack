...
public:
	...
	class AReadyOrNotGameMode_PVP*               K2Node_DynamicCast_AsReady_or_Not_Game_Mode_PVP;   // 0x10(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2B46[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ACoopGM*                               K2Node_DynamicCast_AsCoop_GM;                      // 0x20(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
