...
public:
	...
	uint8                                        Pad_C8A[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C8B[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C9B[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_CDF[0xF0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D06[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D21[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	TArray<class FString>                        EnabledPlugins;                                    // 0x58(0x10)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<class FString>                        DisabledPlugins;                                   // 0x68(0x10)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<class FString>                        AdditionalPluginMetadataKeys;                      // 0x78(0x10)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	uint8                                        Pad_D33[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
