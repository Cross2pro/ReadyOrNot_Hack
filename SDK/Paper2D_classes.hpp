...
public:
	...
	struct FLinearColor                          SpriteColor;                                       // 0x5C8(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	TArray<struct FSpriteInstanceData>           PerInstanceSpriteData;                             // 0x5B8(0x10)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_1A94[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1ACB[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1AEA[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FLinearColor                          SpriteColor;                                       // 0x5B8(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_1CED[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        BitPad_B8 : 4;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
...
public:
	...
	struct FLinearColor                          TileMapColor;                                      // 0x5D8(0x10)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_219F[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2480[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_24FD[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
