...
struct UChatMessage_Entry_C_Get_ChatType_Text_0_Params
{
public:
...
public:
	...
	class AGameStateBase*                        CallFunc_GetGameState_ReturnValue;                 // 0xF8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AReadyOrNotGameState*                  K2Node_DynamicCast_AsReady_or_Not_Game_State;      // 0x100(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_Conv_StringToText_ReturnValue_4;          // 0x130(0x18)(None)
};
