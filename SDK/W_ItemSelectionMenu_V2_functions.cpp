...
void UW_ItemSelectionMenu_V2_C::Get_Item_Categories(class AReadyOrNotCharacter* Self2, TArray<struct FItemSelectionGroup>* ItemSelectionGroups, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue)
{
	...
	Params::UW_ItemSelectionMenu_V2_C_Get_Item_Categories_Params Parms{};
...
// class UW_ItemSelection_ItemList_V2_C*CallFunc_Get_List_At_Index_Return_Value                          (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TArray<struct FItemSelectionGroup> CallFunc_Get_Item_Categories_ItemSelectionGroups                 (ReferenceParm)
// bool                               CallFunc_EqualEqual_IntInt_ReturnValue                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UW_ItemSelectionMenu_V2_C::OpenMenu(int32 Index, class ACharacter* CallFunc_GetPlayerCharacter_ReturnValue, class AReadyOrNotCharacter* K2Node_DynamicCast_AsReady_or_Not_Character, bool K2Node_DynamicCast_bSuccess, TArray<struct FItemSelectionGroup>& CallFunc_Get_Item_Categories_ItemSelectionGroups, bool CallFunc_EqualEqual_IntInt_ReturnValue, const struct FFMODEventInstance& CallFunc_PlayEvent2D_ReturnValue, class UPanelWidget* CallFunc_GetParent_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsInViewport_ReturnValue, bool CallFunc_BooleanOR_ReturnValue)
{
	...
	Parms.K2Node_DynamicCast_bSuccess = K2Node_DynamicCast_bSuccess;
	Parms.CallFunc_Get_Item_Categories_ItemSelectionGroups = CallFunc_Get_Item_Categories_ItemSelectionGroups;
	Parms.CallFunc_EqualEqual_IntInt_ReturnValue = CallFunc_EqualEqual_IntInt_ReturnValue;
