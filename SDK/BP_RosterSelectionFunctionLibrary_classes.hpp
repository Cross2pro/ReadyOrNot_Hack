...
public:
	...
	void StressPercentageAsText(class URosterCharacter* Character, class UObject* __WorldContext, class FText* Text, class FText CallFunc_Conv_DoubleToText_ReturnValue, double CallFunc_Conv_DoubleToText_Value_ImplicitCast);
