...
public:
	...
	struct FMovieSceneSequencePlaybackSettings   PlaybackSettings;                                  // 0x2B0(0x20)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, ExposeOnSpawn, NativeAccessSpecifierPublic)
	...
	struct FLevelSequenceCameraSettings          CameraSettings;                                    // 0x2E0(0x2)(Edit, BlueprintVisible, NoDestructor, ExposeOnSpawn, NativeAccessSpecifierPublic)
	uint8                                        Pad_A9F[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FWorldPartitionResolveData            WorldPartitionResolveData;                         // 0x318(0x20)(NativeAccessSpecifierPrivate)
...
{
public:
	struct FLevelSequencePlayerSnapshot          FrameInformation;                                  // 0x2C0(0xC8)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_C61[0x130];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C9D[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_CB1[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
