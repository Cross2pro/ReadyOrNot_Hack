...
void UW_Footer_C::ExecuteUbergraph_W_Footer(int32 EntryPoint, class UHumanCharacterHUD_V2* CallFunc_GetPlayerHUD_ReturnValue, class FText CallFunc_GetFooterText_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue_1, float K2Node_Event_HeldTime, const struct FVector2D& CallFunc_MakeVector2D_ReturnValue, double CallFunc_MakeVector2D_X_ImplicitCast)
{
	static class UFunction* Func = nullptr;
