...
public:
	...
	uint8                                        Pad_16B6[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_16E1[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_16E2[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_16F5[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
