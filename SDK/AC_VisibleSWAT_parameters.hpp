...
struct UAC_VisibleSWAT_C_Score_Params
{
public:
	...
	float                                        CallFunc_GetVisibleSWATPercentage_ReturnValue;     // 0x20(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
