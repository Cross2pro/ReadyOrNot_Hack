...
void UW_PreMission_Tablet_Objectives_Entry_C::UpdateObjectiveInfo(bool CallFunc_IsValid_ReturnValue, class FText CallFunc_GetFormattedDescription_ReturnValue, class FText CallFunc_GetFormattedName_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UW_PreMission_Tablet_Objectives_Entry_C_UpdateObjectiveInfo_Params Parms{};
...
// Parameters:
// class AObjective*                  Objective                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AObjective*                  CallFunc_GetClassDefaultObject_ReturnValue                       (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class FText                        CallFunc_GetFormattedDescription_ReturnValue                     (None)
// class FText                        CallFunc_GetFormattedName_ReturnValue                            (None)
// bool                               CallFunc_IsValidClass_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AObjective*                  K2Node_CustomEvent_Objective                                     (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class ADefuseBombThreats*          K2Node_DynamicCast_AsDefuse_Bomb_Threats                         (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
