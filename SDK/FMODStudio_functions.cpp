...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UFMODEvent*                  NewEvent                                                         (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UFMODAudioComponent::GetPaused()
{
	...
	if (!Func)
		Func = Class->GetFunction("FMODAudioComponent", "GetPaused");

	Params::UFMODAudioComponent_GetPaused_Params Parms{};
...
class UClass* UFMODAudioLinkComponent::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FMODAudioLinkComponent");

	return Clss;
}


// FMODAudioLinkComponent FMODStudio.Default__FMODAudioLinkComponent
// (Public, ClassDefaultObject, ArchetypeObject)

class UFMODAudioLinkComponent* UFMODAudioLinkComponent::GetDefaultObj()
{
	static class UFMODAudioLinkComponent* Default = nullptr;

	if (!Default)
		Default = static_cast<UFMODAudioLinkComponent*>(UFMODAudioLinkComponent::StaticClass()->DefaultObject);
...
class UClass* UFMODAudioLinkSettings::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FMODAudioLinkSettings");

	return Clss;
}


// FMODAudioLinkSettings FMODStudio.Default__FMODAudioLinkSettings
// (Public, ClassDefaultObject, ArchetypeObject)

class UFMODAudioLinkSettings* UFMODAudioLinkSettings::GetDefaultObj()
{
	static class UFMODAudioLinkSettings* Default = nullptr;

	if (!Default)
		Default = static_cast<UFMODAudioLinkSettings*>(UFMODAudioLinkSettings::StaticClass()->DefaultObject);
...
// Parameters:
// class UFMODVCA*                    Vca                                                              (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              Volume                                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// class UFMODBank*                   Bank                                                             (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UFMODEvent*                  Event                                                            (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FTransform                  Location                                                         (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               bAutoPlay                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Parameters:
// class FString                      Name                                                             (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UFMODAsset*                  ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Parameters:
// struct FFMODEventInstance          EventInstance                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct FTransform                  Location                                                         (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// class UFMODBus*                    Bus                                                              (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
