...
public:
	...
	uint8                                        Pad_2C3A[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2C56[0x128];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2C58[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2CAD[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
