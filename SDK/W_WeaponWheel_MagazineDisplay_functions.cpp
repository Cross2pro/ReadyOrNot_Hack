...
// class UW_WeaponWheel_MagazineSlot_C*CallFunc_SpawnObject_ReturnValue                                 (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// double                             K2Node_VariableSet_MaxAmmo_ImplicitCast                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_WeaponWheel_MagazineDisplay_C::Initialize(class ABaseMagazineWeapon* InMagazineWeapon, double IconSize, double K2Node_VariableSet_MaxAmmo_ImplicitCast)
{
	static class UFunction* Func = nullptr;
	...
	Parms.K2Node_VariableSet_MaxAmmo_ImplicitCast = K2Node_VariableSet_MaxAmmo_ImplicitCast;
...
// class UW_WeaponWheel_MagazineSlot_C*CurrentMagSlot                                                   (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               Temp_bool_Variable                                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              Temp_int_Variable                                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_Add_IntInt_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Not_PreBool_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_BooleanAND_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UW_WeaponWheel_MagazineSlot_C*CallFunc_CreateMagSlot_ReturnValue                               (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UW_WeaponWheel_MagazineDisplay_C::ExecuteUbergraph_W_WeaponWheel_MagazineDisplay(int32 EntryPoint, const struct FGeometry& K2Node_Event_MyGeometry, float K2Node_Event_InDeltaTime, bool K2Node_Event_IsDesignTime)
{
	static class UFunction* Func = nullptr;
