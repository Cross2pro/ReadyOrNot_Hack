...
public:
	...
	class UW_PreMission_Tablet_MapMarker_C*      CallFunc_Create_ReturnValue;                       // 0x8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UW_OfficerMarker_C*                    CallFunc_Create_ReturnValue_1;                     // 0x10(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FPlanningMarker                       K2Node_MakeStruct_PlanningMarker;                  // 0x30(0x30)(NoDestructor)
	...
	class USizeBoxSlot*                          CallFunc_SlotAsSizeBoxSlot_ReturnValue;            // 0x70(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	float                                        K2Node_MakeStruct_Rotation_ImplicitCast;           // 0x80(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
