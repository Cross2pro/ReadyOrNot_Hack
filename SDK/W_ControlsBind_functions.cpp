...
void UW_ControlsBind_C::SetupDescription(class UW_Options_UE5_C* CallFunc_FindParentWidgetOfType_ReturnValue)
{
	...
	Params::UW_ControlsBind_C_SetupDescription_Params Parms{};
...
struct FEventReply UW_ControlsBind_C::Click_Listener_Button_Down(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent, const struct FEventReply& CallFunc_Unhandled_ReturnValue, const struct FEventReply& CallFunc_HandleMouseButtonDown_Reply)
{
	static class UFunction* Func = nullptr;
	...
	Params::UW_ControlsBind_C_Click_Listener_Button_Down_Params Parms{};
...
// class UW_ControlsBind_C*           TempActionToRemove                                               (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UW_ControlsBind_C*           TempAxisToRemove                                                 (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// double                             TempScale                                                        (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_ControlsBind_C::Add_Keybinds_to_List_OLD(TArray<struct FSKeybinding>& Keybinds, class FName AxisMapping, double Scale, TArray<struct FAxisMappingStruct>& AxesList, TArray<struct FActionMappingStruct>& ActionsList, double TempScale)
{
	static class UFunction* Func = nullptr;
...
// TArray<struct FAxisMappingStruct>  Axes                                                             (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// TArray<struct FActionMappingStruct>Actions                                                          (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// double                             ControlsScale                                                    (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FName                        TempMappingName                                                  (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_ControlsBind_C::Add_Conflicting_Keybinds_to_List_OLD(class FName MappingName, double Scale, TArray<struct FAxisMappingStruct>& Axes, TArray<struct FActionMappingStruct>& Actions, double ControlsScale, class FName TempMappingName)
{
	static class UFunction* Func = nullptr;
...
// bool                               CallFunc_GetAllAxisMappings_ReturnValue                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TArray<struct FAxisMappingStruct>  CallFunc_GetAllAxisMappings_AxisMappings                         (ReferenceParm)
// int32                              CallFunc_Array_Length_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_GetConflictingKeybindsWhenValid_HasConflict             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_RebindKey_ReturnValue                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
