...
struct UAG_CanEverSuicide_C_CanOpen_Params
{
public:
	...
	bool                                         CallFunc_CanEverSuicide_ReturnValue;               // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
