...
void UW_Dropdown_C::OpenMenu(bool CallFunc_IsOpen_ReturnValue, double CallFunc_SelectFloat_ReturnValue, const struct FVector2D& CallFunc_MakeVector2D_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UW_Dropdown_C::CloseMenu(const struct FVector2D& CallFunc_MakeVector2D_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// class UW_DropdownMenu_C*           CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// Function w_Dropdown.w_Dropdown_C.OnMenuOpened__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:

void UW_Dropdown_C::OnMenuOpened__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("w_Dropdown_C", "OnMenuOpened__DelegateSignature");
...
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UW_Dropdown_C*               Dropdown                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
