...
public:
	...
	uint8                                        Pad_965[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<struct FProcMeshSection>              ProcMeshSections;                                  // 0x5C0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FKConvexElem>                  CollisionConvexElems;                              // 0x5D0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	struct FBoxSphereBounds                      LocalBounds;                                       // 0x5E0(0x38)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
