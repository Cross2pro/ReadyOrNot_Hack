...
void UANIMBP_AKS74U_C::ExecuteUbergraph_ANIMBP_AKS74U(int32 EntryPoint, double Temp_real_Variable, double Temp_real_Variable_1, bool Temp_bool_Variable, float K2Node_Event_DeltaTimeX, class AActor* CallFunc_GetOwningActor_ReturnValue, class ABaseItem* K2Node_DynamicCast_AsBase_Item, bool K2Node_DynamicCast_bSuccess, double K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
