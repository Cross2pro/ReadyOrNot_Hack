...
class UWidget* UBP_MessageDisplayBox_C::BP_GetDesiredFocusTarget()
{
	...
	Params::UBP_MessageDisplayBox_C_BP_GetDesiredFocusTarget_Params Parms{};
...
// Function BP_MessageDisplayBox.BP_MessageDisplayBox_C.OnClick__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:

void UBP_MessageDisplayBox_C::OnClick__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MessageDisplayBox_C", "OnClick__DelegateSignature");
