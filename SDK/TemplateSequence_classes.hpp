...
public:
	...
	uint8                                        Pad_AF4[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_AFA[0x74];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B2F[0x270];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B45[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_BAB[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_BB0[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_BB7[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	struct FMovieSceneSequencePlaybackSettings   PlaybackSettings;                                  // 0x2A0(0x20)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FSoftObjectPath                       TemplateSequence;                                  // 0x2C8(0x20)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTemplateSequenceBindingOverrideData  BindingOverride;                                   // 0x2E8(0xC)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_C0F[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
