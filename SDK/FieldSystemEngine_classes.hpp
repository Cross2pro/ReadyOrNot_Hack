...
{
public:
	uint8                                        Pad_6FA[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	struct FFieldObjectCommands                  ConstructionCommands;                              // 0x590(0x30)(ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FFieldObjectCommands                  BufferCommands;                                    // 0x5C0(0x30)(ContainsInstancedReference, NativeAccessSpecifierPublic)
	uint8                                        Pad_809[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_832[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_848[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_868[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_8AF[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_8EE[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_91A[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_95E[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9B8[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_A39[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C1D[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
