...
public:
	...
	struct FAnimNode_RefPose                     AnimGraphNode_LocalRefPose;                        // 0x538(0x10)(None)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;               // 0x548(0x20)(None)
	double                                       MagScale;                                          // 0x568(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void ExecuteUbergraph_ANIMBP_M37(int32 EntryPoint, double Temp_real_Variable, double Temp_real_Variable_1, bool Temp_bool_Variable, float K2Node_Event_DeltaTimeX, class AActor* CallFunc_GetOwningActor_ReturnValue, class ABaseItem* K2Node_DynamicCast_AsBase_Item, bool K2Node_DynamicCast_bSuccess, double K2Node_Select_Default);
};
