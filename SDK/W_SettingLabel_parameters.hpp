...
struct UW_SettingLabel_C_CopyFromCombo_Params
{
public:
...
struct UW_SettingLabel_C_CopyFromSlider_Params
{
public:
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UW_SettingLabel_C_CopyFromCheckbox_Params
{
public:
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UW_SettingLabel_C_PreConstruct_Params
{
public:
...
struct UW_SettingLabel_C_BndEvt__W_SettingLabel_Button_K2Node_ComponentBoundEvent_2_Hovered__DelegateSignature_Params
{
public:
...
struct UW_SettingLabel_C_ExecuteUbergraph_W_SettingLabel_Params
{
public:
