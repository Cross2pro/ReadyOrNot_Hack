...
public:
	...
	uint8                                        Pad_15D4[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	struct FSoftObjectPath                       LevelVariantSets;                                  // 0x298(0x20)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_16BF[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1719[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1745[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_174B[0x6F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_18E2[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1DC8[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_20DF[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
