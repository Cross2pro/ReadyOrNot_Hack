...
// double                             TotalRemainingWeaponAmmo                                         (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAC_AllWeaponAmmo_C::GetTotalRemainingAmmoFromAllMags(class ABaseMagazineWeapon* Weapon, double* Return_Value, double TotalRemainingWeaponAmmo, int32 Temp_int_Array_Index_Variable, int32 CallFunc_Array_Length_ReturnValue, float CallFunc_GetAmmoInMagazine_ReturnValue, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, double CallFunc_Add_DoubleDouble_ReturnValue, double CallFunc_Add_DoubleDouble_A_ImplicitCast)
{
...
// class ABaseMagazineWeapon*         EquippedWeapon                                                   (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
...
// class AMeleeWeapon*                K2Node_DynamicCast_AsMelee_Weapon                                (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// double                             CallFunc_GetTotalRemainingAmmoFromAllMags_Return_Value           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
