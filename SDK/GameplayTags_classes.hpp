...
public:
	...
	uint8                                        Pad_E55[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F2A[0x160];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x188(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_F2B[0xB0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F95[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
