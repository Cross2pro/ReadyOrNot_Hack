...
public:
	...
	bool                                         CallFunc_IsAnimationPlaying_ReturnValue;           // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_2447[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class USoundWave*                            CallFunc_GetTimelineEventTestData_Audio_Asset;     // 0x20(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<struct FTimelineEvent>                CallFunc_GetTimelineEventTestData_Events;          // 0x28(0x10)(ReferenceParm)
	TMap<double, struct FTimelineEvent>          CallFunc_GetTimelineEventTestData_EventEntries;    // 0x38(0x50)(None)
	...
	double                                       K2Node_VariableSet_EventAudioStart_ImplicitCast;   // 0xE0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                       K2Node_VariableSet_EventAudioDuration_ImplicitCast; // 0xE8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
