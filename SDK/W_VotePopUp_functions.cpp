...
// bool                               CallFunc_CanVoteNo_Return_Value                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UW_VotePopUp_C::ExecuteUbergraph_W_VotePopUp(int32 EntryPoint, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, class FText K2Node_CustomEvent_VoteReason, class FText K2Node_CustomEvent_VoteQuestion, bool K2Node_CustomEvent_bCanVoteNo, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
