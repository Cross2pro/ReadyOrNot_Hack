...
void UW_Radial_MapMarking_C::Give_Focus_To_Map(bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::UW_Radial_MapMarking_C_Give_Focus_To_Map_Params Parms{};
...
struct FEventReply UW_Radial_MapMarking_C::OnAnalogValueChanged(const struct FGeometry& MyGeometry, const struct FAnalogInputEvent& InAnalogInputEvent, float CallFunc_GetAnalogValue_ReturnValue, const struct FVector& CallFunc_Conv_Vector2DToVector_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, double CallFunc_BreakVector_X, double CallFunc_BreakVector_Y, double CallFunc_BreakVector_Z, float CallFunc_GetAnalogValue_ReturnValue_1, const struct FKeyEvent& CallFunc_GetKeyEventFromAnalogInputEvent_ReturnValue, const struct FVector2D& CallFunc_MakeVector2D_ReturnValue, const struct FKey& CallFunc_GetKey_ReturnValue, bool CallFunc_EqualEqual_KeyKey_ReturnValue, bool CallFunc_EqualEqual_KeyKey_ReturnValue_1, const struct FEventReply& CallFunc_Unhandled_ReturnValue, double Temp_real_Variable, const struct FVector2D& CallFunc_MakeVector2D_ReturnValue_1, float CallFunc_GetAnalogValue_ReturnValue, const struct FEventReply& CallFunc_Handled_ReturnValue, double CallFunc_Multiply_DoubleDouble_A_ImplicitCast, double K2Node_VariableSetRef_Target_ImplicitCast, double CallFunc_MakeVector2D_X_ImplicitCast)
{
	...
	Params::UW_Radial_MapMarking_C_OnAnalogValueChanged_Params Parms{};
...
void UW_Radial_MapMarking_C::InitGamepadSupport(class UCommonInputSubsystem* CallFunc_GetLocalPlayerSubsystem_ReturnValue, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UW_Radial_MapMarking_C::HandleGamepad(class UUMG_RadialMenu_C* UMGRadial, bool CallFunc_IsValid_ReturnValue, class FName CallFunc_Conv_StringToName_ReturnValue, double CallFunc_VSize2D_ReturnValue, bool CallFunc_LessEqual_DoubleDouble_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UW_Radial_MapMarking_C::SetGamepadInputDirection(class UUMG_RadialMenu_C* UMGRadial, double CallFunc_VSize2D_ReturnValue, bool CallFunc_Less_DoubleDouble_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// class UW_RadialIcon_MapMarking_C*  CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// FDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// bool                               K2Node_CustomEvent_HasSubCommands                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UW_RadialIcon_MapMarking_C*  CallFunc_Create_ReturnValue_1                                    (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// struct FSt_PreMissionMarkers       CallFunc_GetDataTableRowFromName_OutRow_1                        (ContainsInstancedReference, HasGetValueTypeHash)
// bool                               CallFunc_GetDataTableRowFromName_ReturnValue_1                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_AddChildToRadialMenu_Success_1                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UUMGSequencePlayer*          CallFunc_PlayAnimationReverse_ReturnValue                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UUserWidget*                 CallFunc_GetChild_Output                                         (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_GetChild_Success                                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UW_RadialIcon_MapMarking_C*  K2Node_DynamicCast_AsW_Radial_Icon_Map_Marking                   (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// class UUserWidget*                 CallFunc_GetChild_Output_1                                       (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_GetChild_Success_1                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_NotEqual_IntInt_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UW_RadialIcon_MapMarking_C*  K2Node_DynamicCast_AsW_Radial_Icon_Map_Marking_1                 (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// class UUserWidget*                 CallFunc_GetChild_Output_2                                       (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_GetChild_Success_2                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UW_RadialIcon_MapMarking_C*  K2Node_DynamicCast_AsW_Radial_Icon_Map_Marking_2                 (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// struct FSt_PreMissionMarker_CategoriesCallFunc_GetDataTableRowFromName_OutRow_2                        (HasGetValueTypeHash)
