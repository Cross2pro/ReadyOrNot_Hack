...
// double                             K2Node_VariableSet_EventAudioStart_ImplicitCast                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                             K2Node_VariableSet_EventAudioDuration_ImplicitCast               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UW_Briefing_Event_C::ExecuteUbergraph_W_Briefing_Event(int32 EntryPoint, class UW_Button_C* K2Node_ComponentBoundEvent_Button, class UW_Button_C* K2Node_ComponentBoundEvent_Button_1, bool K2Node_Event_IsDesignTime, bool CallFunc_TextIsEmpty_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, class USoundWave* CallFunc_GetTimelineEventTestData_Audio_Asset, TArray<struct FTimelineEvent>& CallFunc_GetTimelineEventTestData_Events, TMap<double, struct FTimelineEvent> CallFunc_GetTimelineEventTestData_EventEntries, const struct FTimelineEvent& CallFunc_Array_Get_Item, double CallFunc_Add_DoubleDouble_ReturnValue, double K2Node_VariableSet_EventAudioStart_ImplicitCast, double K2Node_VariableSet_EventAudioDuration_ImplicitCast)
{
	...
	Parms.K2Node_VariableSet_EventAudioStart_ImplicitCast = K2Node_VariableSet_EventAudioStart_ImplicitCast;
	Parms.K2Node_VariableSet_EventAudioDuration_ImplicitCast = K2Node_VariableSet_EventAudioDuration_ImplicitCast;
...
void UW_Briefing_Event_C::TimelineEventClicked__DelegateSignature(double EventAudioStart, double EventAudioDuration)
{
	static class UFunction* Func = nullptr;
...
void UW_Briefing_Event_C::TimelineEventUnhovered__DelegateSignature(double EventID)
{
	static class UFunction* Func = nullptr;
...
void UW_Briefing_Event_C::TimelineEventHovered__DelegateSignature(double EventID)
{
	static class UFunction* Func = nullptr;
