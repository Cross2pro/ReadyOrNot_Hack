...
void UW_RosterSelf_Card_C::SetupAptitude(class UProgressBar* ProgressBar, class UTextBlock* TextBlock, double Percent, double CallFunc_Multiply_DoubleDouble_ReturnValue, int32 CallFunc_Round_ReturnValue, class FText CallFunc_Conv_IntToText_ReturnValue, float CallFunc_SetPercent_InPercent_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
void UW_RosterSelf_Card_C::ProxyUpdateTeam(enum class EPlanningLineTeam Team)
{
	static class UFunction* Func = nullptr;
	...
	Params::UW_RosterSelf_Card_C_ProxyUpdateTeam_Params Parms{};
...
void UW_RosterSelf_Card_C::UpdateTeam(enum class EPlanningLineTeam Team)
{
	static class UFunction* Func = nullptr;
	...
	Params::UW_RosterSelf_Card_C_UpdateTeam_Params Parms{};
...
// enum class EPlanningLineTeam       K2Node_CustomEvent_Team_1                                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               Temp_bool_Variable_1                                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// class UW_RosterSelf_Card_C*        Card                                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
