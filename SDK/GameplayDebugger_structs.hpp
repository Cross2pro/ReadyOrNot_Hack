...
public:
	...
	uint8                                        Pad_F56[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class FName                                  CategoryName;                                      // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        DataPackIdx;                                       // 0x8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayDebuggerDataPackHeader       Header;                                            // 0xC(0x10)(NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_F7A[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	class FName                                  ActorName;                                         // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int16                                        SyncCounter;                                       // 0x10(0x2)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_F89[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
