...
class UClass* UGeometrySelectionVisualizationProperties::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GeometrySelectionVisualizationProperties");

	return Clss;
}


// GeometrySelectionVisualizationProperties ModelingComponents.Default__GeometrySelectionVisualizationProperties
// (Public, ClassDefaultObject, ArchetypeObject)

class UGeometrySelectionVisualizationProperties* UGeometrySelectionVisualizationProperties::GetDefaultObj()
{
	static class UGeometrySelectionVisualizationProperties* Default = nullptr;

	if (!Default)
		Default = static_cast<UGeometrySelectionVisualizationProperties*>(UGeometrySelectionVisualizationProperties::StaticClass()->DefaultObject);
...
class UTriangleSetComponent* UPreviewGeometry::FindTriangleSet(const class FString& TriangleSetIdentifier)
{
	...
	Params::UPreviewGeometry_FindTriangleSet_Params Parms{};
...
class UTriangleSetComponent* UPreviewGeometry::AddTriangleSet(const class FString& TriangleSetIdentifier)
{
	...
	Params::UPreviewGeometry_AddTriangleSet_Params Parms{};
...
class UClass* UCollisionPrimitivesMechanic::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CollisionPrimitivesMechanic");

	return Clss;
}


// CollisionPrimitivesMechanic ModelingComponents.Default__CollisionPrimitivesMechanic
// (Public, ClassDefaultObject, ArchetypeObject)

class UCollisionPrimitivesMechanic* UCollisionPrimitivesMechanic::GetDefaultObj()
{
	static class UCollisionPrimitivesMechanic* Default = nullptr;

	if (!Default)
		Default = static_cast<UCollisionPrimitivesMechanic*>(UCollisionPrimitivesMechanic::StaticClass()->DefaultObject);
...
struct FCreateActorResult UModelingObjectsCreationAPI::CreateNewActor(struct FCreateActorParams& CreateActorParams)
{
	...
	Params::UModelingObjectsCreationAPI_CreateNewActor_Params Parms{};

	Parms.CreateActorParams = CreateActorParams;
...
struct FCreateMaterialObjectResult UModelingObjectsCreationAPI::CreateMaterialObject(struct FCreateMaterialObjectParams& CreateMaterialParams)
{
	...
	Params::UModelingObjectsCreationAPI_CreateMaterialObject_Params Parms{};

	Parms.CreateMaterialParams = CreateMaterialParams;
