...
void UW_Briefing_TimelineEvents_C::Initialize(TMap<double, struct FTimelineEvent> EventEntries)
{
	static class UFunction* Func = nullptr;
...
// double                             K2Node_CustomEvent_EventAudioStart                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                             K2Node_CustomEvent_EventAudioDuration                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// FDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// TMap<double, struct FTimelineEvent>K2Node_CustomEvent_EventEntries                                  (None)
// double                             K2Node_CustomEvent_EventID                                       (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UW_Briefing_Event_C*         CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UW_Briefing_TimelineEvents_C::OnEventClicked__DelegateSignature(double EventAudioStart, double EventAudioDuration)
{
	static class UFunction* Func = nullptr;
