...
struct UABP_WP_MP5SD_C_AnimGraph_Params
{
public:
...
struct UABP_WP_MP5SD_C_BlueprintUpdateAnimation_Params
{
public:
...
struct UABP_WP_MP5SD_C_ExecuteUbergraph_ABP_WP_MP5SD_Params
{
public:
	...
	float                                        K2Node_StructMemberSet_Alpha_ImplicitCast;         // 0x2C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
