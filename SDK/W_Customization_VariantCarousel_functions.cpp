...
void UW_Customization_VariantCarousel_C::AddVariantToMaps(class UW_Customization_Slot_C* Slot, const class FString& CallFunc_GetObjectName_ReturnValue, class FName CallFunc_Conv_StringToName_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// class UW_Customization_Slot_C*     NewSlotWidget                                                    (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UW_Customization_VariantCarousel_C::GetActionIconSizeRatio(class UCommonActionWidget* CommonActionWidget, double* IconRatio, const struct FSlateBrush& CallFunc_GetIcon_ReturnValue, double CallFunc_BreakVector2D_X, double CallFunc_BreakVector2D_Y, bool CallFunc_NotEqual_Vector2DVector2D_ReturnValue, double CallFunc_Divide_DoubleDouble_ReturnValue, bool CallFunc_Greater_DoubleDouble_ReturnValue, double CallFunc_SelectFloat_ReturnValue, const struct FVector2D& CallFunc_BreakVector2D_InVec_ImplicitCast, const struct FVector2D& CallFunc_NotEqual_Vector2DVector2D_A_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
// class UW_Customization_Slot_C*     CallFunc_CreateSlotWidget_NewSlot                                (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// class UW_Customization_Slot_C*     CallFunc_CreateSlotWidget_NewSlot_1                              (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// class UW_Customization_Slot_C*     CallFunc_Map_Find_Value                                          (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// bool                               K2Node_CustomEvent_RefreshList                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
