...
struct IReadyOrNotUI_C_BackPage_Params
{
public:
...
struct IReadyOrNotUI_C_ChangePage_Params
{
public:
...
struct IReadyOrNotUI_C_GetFocusTarget_Params
{
public:
...
struct IReadyOrNotUI_C_SetInputMode_Params
{
public:
...
struct IReadyOrNotUI_C_Hide_Params
{
public:
...
struct IReadyOrNotUI_C_Reveal_Params
{
public:
	double                                       Delay;                                             // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
