...
// Parameters:
// class UWidget*                     AnalogScrollRecipient                                            (ConstParm, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCommonUserWidget::UnregisterScrollRecipientExternal(class UWidget* AnalogScrollRecipient)
{
	...
	Params::UCommonUserWidget_UnregisterScrollRecipientExternal_Params Parms{};
...
void UCommonUserWidget::RegisterScrollRecipientExternal(class UWidget* AnalogScrollRecipient)
{
	static class UFunction* Func = nullptr;
	...
	Params::UCommonUserWidget_RegisterScrollRecipientExternal_Params Parms{};
...
class UClass* UCommonCarousel::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CommonCarousel");

	return Clss;
}


// CommonCarousel CommonUI.Default__CommonCarousel
// (Public, ClassDefaultObject, ArchetypeObject)

class UCommonCarousel* UCommonCarousel::GetDefaultObj()
{
	static class UCommonCarousel* Default = nullptr;

	if (!Default)
		Default = static_cast<UCommonCarousel*>(UCommonCarousel::StaticClass()->DefaultObject);
...
void UCommonCarousel::SetSelection(class FName OptionNameID)
{
	...
	Params::UCommonCarousel_SetSelection_Params Parms{};
...
void UCommonCarousel::SetOptions(TMap<class FName, class FText> NewOptions)
{
	static class UFunction* Func = nullptr;
	...
	Params::UCommonCarousel_SetOptions_Params Parms{};
...
void UCommonCarousel::SetOptionLabelTextByID(class FName OptionNameID, class FText NewLabelText)
{
	...
	Params::UCommonCarousel_SetOptionLabelTextByID_Params Parms{};
...
void UCommonCarousel::SetListeningForInput(bool bShouldListen)
{
	...
	Params::UCommonCarousel_SetListeningForInput_Params Parms{};
...
void UCommonCarousel::RemoveOption(class FName OptionNameID)
{
	...
	Params::UCommonCarousel_RemoveOption_Params Parms{};
...
void UCommonCarousel::OptionSelected(class FName OptionNameID)
{
	...
	Params::UCommonCarousel_OptionSelected_Params Parms{};
...
void UCommonCarousel::OnPreviousHandled__DelegateSignature(class FName OptionID)
{
	...
	Params::UCommonCarousel_OnPreviousHandled__DelegateSignature_Params Parms{};
...
void UCommonCarousel::OnOptionSelected__DelegateSignature(class FName OptionID)
{
	...
	Params::UCommonCarousel_OnOptionSelected__DelegateSignature_Params Parms{};
...
void UCommonCarousel::OnNextHandled__DelegateSignature(class FName OptionID)
{
	...
	Params::UCommonCarousel_OnNextHandled__DelegateSignature_Params Parms{};
...
void UCommonCarousel::NavigatePrevTerminated(bool Terminated)
{
	...
	Params::UCommonCarousel_NavigatePrevTerminated_Params Parms{};
...
void UCommonCarousel::NavigateNextTerminated(bool Terminated)
{
	...
	Params::UCommonCarousel_NavigateNextTerminated_Params Parms{};
...
void UCommonCarousel::HandlePreviousInputAction(bool* bPassThrough)
{
	...
	Params::UCommonCarousel_HandlePreviousInputAction_Params Parms{};
...
void UCommonCarousel::HandleNextInputAction(bool* bPassThrough)
{
	...
	Params::UCommonCarousel_HandleNextInputAction_Params Parms{};
...
class FName UCommonCarousel::GetSelection()
{
	static class UFunction* Func = nullptr;
	...
	Params::UCommonCarousel_GetSelection_Params Parms{};
...
int32 UCommonCarousel::GetOptionCount()
{
	static class UFunction* Func = nullptr;
	...
	Params::UCommonCarousel_GetOptionCount_Params Parms{};
...
class FName UCommonCarousel::GetOptionAtIndex(int32 Index)
{
	static class UFunction* Func = nullptr;
	...
	Params::UCommonCarousel_GetOptionAtIndex_Params Parms{};
...
// bool                               DefaultSelection                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCommonCarousel::AddOption(class FName OptionNameID, class FText LabelText, bool DefaultSelection)
{
	static class UFunction* Func = nullptr;
	...
	Params::UCommonCarousel_AddOption_Params Parms{};
...
class UCommonTextStyle* UCommonButtonStyle::GetSelectedPressedTextStyle()
{
	static class UFunction* Func = nullptr;
	...
	Params::UCommonButtonStyle_GetSelectedPressedTextStyle_Params Parms{};
...
class UCommonTextStyle* UCommonButtonStyle::GetNormalPressedTextStyle()
{
	static class UFunction* Func = nullptr;
	...
	Params::UCommonButtonStyle_GetNormalPressedTextStyle_Params Parms{};
...
bool UCommonVisibilitySwitcher::IsCurrentlySwitching()
{
	static class UFunction* Func = nullptr;
	...
	Params::UCommonVisibilitySwitcher_IsCurrentlySwitching_Params Parms{};
...
class UClass* UCommonVisibilityWidgetBase::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CommonVisibilityWidgetBase");

	return Clss;
}


// CommonVisibilityWidgetBase CommonUI.Default__CommonVisibilityWidgetBase
// (Public, ClassDefaultObject, ArchetypeObject)

class UCommonVisibilityWidgetBase* UCommonVisibilityWidgetBase::GetDefaultObj()
{
	static class UCommonVisibilityWidgetBase* Default = nullptr;

	if (!Default)
		Default = static_cast<UCommonVisibilityWidgetBase*>(UCommonVisibilityWidgetBase::StaticClass()->DefaultObject);
...
TArray<class FName> UCommonVisibilityWidgetBase::GetRegisteredPlatforms()
{
	...
	if (!Func)
		Func = Class->GetFunction("CommonVisibilityWidgetBase", "GetRegisteredPlatforms");

	Params::UCommonVisibilityWidgetBase_GetRegisteredPlatforms_Params Parms{};
...
void UCommonWidgetGroupBase::AddWidgets(TArray<class UWidget*>& Widgets)
{
	static class UFunction* Func = nullptr;
	...
	Params::UCommonWidgetGroupBase_AddWidgets_Params Parms{};
