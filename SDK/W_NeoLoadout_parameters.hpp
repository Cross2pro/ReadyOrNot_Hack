...
public:
	...
	class ULoadoutItem*                          CurrentItem;                                       // 0x10(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class ULoadoutItem*                          K2Node_ComponentBoundEvent_Item_4;                 // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UW_NeoLoadout_Slot_C*                  K2Node_ComponentBoundEvent_Slot_4;                 // 0x10(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class ULoadoutItem*                          K2Node_ComponentBoundEvent_Item_3;                 // 0x18(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UW_NeoLoadout_Slot_C*                  K2Node_ComponentBoundEvent_Slot_3;                 // 0x20(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class ULoadoutItem*                          K2Node_ComponentBoundEvent_Item_2;                 // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UW_NeoLoadout_Slot_C*                  K2Node_ComponentBoundEvent_Slot_2;                 // 0x30(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TArray<class ULoadoutItem*>                  K2Node_CustomEvent_Items;                          // 0x38(0x10)(ConstParm, ReferenceParm)
	class ULoadoutItem*                          K2Node_CustomEvent_CurrentItem;                    // 0x48(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UW_NeoLoadout_Slot_C*                  CallFunc_Create_ReturnValue;                       // 0x88(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class ULoadoutItem*                          CallFunc_Array_Get_Item;                           // 0xA0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ULoadoutWeapon*                        CallFunc_GetPrimaryWeapon_ReturnValue;             // 0xC8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class ULoadoutWeapon*                        CallFunc_GetSecondaryWeapon_ReturnValue;           // 0xD0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class ULoadoutEquipment*                     CallFunc_GetLongTactical_ReturnValue;              // 0xD8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ULoadoutItem*                          K2Node_ComponentBoundEvent_Item_1;                 // 0xE8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UW_NeoLoadout_Slot_C*                  K2Node_ComponentBoundEvent_Slot_1;                 // 0xF0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class ULoadoutItem*                          K2Node_ComponentBoundEvent_Item;                   // 0xF8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UW_NeoLoadout_Slot_C*                  K2Node_ComponentBoundEvent_Slot;                   // 0x100(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TArray<class ULoadoutEquipment*>             CallFunc_GetTacticalItems_ReturnValue;             // 0x108(0x10)(ConstParm, ReferenceParm)
	class ULoadoutItem*                          K2Node_CustomEvent_Item;                           // 0x118(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UW_NeoLoadout_Slot_C*                  K2Node_CustomEvent_Slot;                           // 0x120(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class ULoadoutWeapon*                        K2Node_DynamicCast_AsLoadout_Weapon;               // 0x128(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ULoadoutWeapon*                        K2Node_DynamicCast_AsLoadout_Weapon_1;             // 0x138(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess_1;                     // 0x140(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_E64[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class ULoadoutEquipment*                     K2Node_DynamicCast_AsLoadout_Equipment;            // 0x148(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
