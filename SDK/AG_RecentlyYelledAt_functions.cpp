...
// bool                               CallFunc_WasRecentlyYelledAt_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                              CallFunc_WasRecentlyYelledAt_Seconds_ImplicitCast                (ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

bool UAG_RecentlyYelledAt_C::CanOpen(struct FAIActionDecisionContext& Context, class ACyberneticCharacter* CallFunc_GetCharacter_ReturnValue, bool CallFunc_WasRecentlyYelledAt_ReturnValue, float CallFunc_WasRecentlyYelledAt_Seconds_ImplicitCast)
{
	...
	Parms.CallFunc_WasRecentlyYelledAt_Seconds_ImplicitCast = CallFunc_WasRecentlyYelledAt_Seconds_ImplicitCast;
