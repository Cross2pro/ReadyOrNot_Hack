...
struct UAC_LastTimeExposedtoGas_C_Score_Params
{
public:
	...
	float                                        CallFunc_GetTimeSinceLastTookStunDamageOfType_TimeSinceTookStunDamage; // 0x20(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_GetTimeSinceLastTookStunDamageOfType_ReturnValue; // 0x24(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                       CallFunc_MapRangeClamped_InRangeB_ImplicitCast;    // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                       CallFunc_MapRangeClamped_InRangeA_ImplicitCast;    // 0x40(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
