...
class UANIMBP_USP_C : public URoNWeaponAnimInstance
{
public:
	...
	void ExecuteUbergraph_ANIMBP_USP(int32 EntryPoint, int32 CallFunc_Round_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, double CallFunc_Round_A_ImplicitCast);
};
