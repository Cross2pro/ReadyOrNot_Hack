...
void UW_Briefing_Media_AudioEntry_C::OnAddedToFocusPath(const struct FFocusEvent& InFocusEvent)
{
	...
	Params::UW_Briefing_Media_AudioEntry_C_OnAddedToFocusPath_Params Parms{};
...
void UW_Briefing_Media_AudioEntry_C::OnRemovedFromFocusPath(const struct FFocusEvent& InFocusEvent)
{
	...
	Params::UW_Briefing_Media_AudioEntry_C_OnRemovedFromFocusPath_Params Parms{};
...
void UW_Briefing_Media_AudioEntry_C::ExecuteUbergraph_W_Briefing_Media_AudioEntry(int32 EntryPoint, const struct FFocusEvent& K2Node_Event_InFocusEvent, bool K2Node_Event_IsDesignTime, const struct FFocusEvent& K2Node_Event_InFocusEvent_1)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UW_Briefing_Media_AudioEntry_C*AudioEntry                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
