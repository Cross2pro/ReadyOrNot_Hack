...
public:
	...
	void GetColorByName(class FName ColorName, double Opacity, struct FLinearColor* LinearColor, struct FSlateColor* SlateColor, const struct FLinearColor& SelectedColor, bool K2Node_SwitchName_CmpSuccess, const struct FLinearColor& K2Node_MakeStruct_LinearColor, const struct FSlateColor& K2Node_MakeStruct_SlateColor, float K2Node_MakeStruct_A_ImplicitCast);
	void GetTeamColors(double Opacity, struct FLinearColor* Gold, struct FLinearColor* Red, struct FLinearColor* Blue, const struct FLinearColor& CallFunc_GetGoldTeamColor_GoldTeam, const struct FLinearColor& CallFunc_GetBlueTeamColor_BlueTeam, const struct FLinearColor& CallFunc_GetRedTeamColor_RedTeam);
	void GetBlueTeamColor(double Opacity, struct FLinearColor* BlueTeam, const struct FLinearColor& K2Node_MakeStruct_LinearColor, float K2Node_MakeStruct_A_ImplicitCast);
	void GetRedTeamColor(double Opacity, struct FLinearColor* RedTeam, const struct FLinearColor& K2Node_MakeStruct_LinearColor, float K2Node_MakeStruct_A_ImplicitCast);
	void GetGoldTeamColor(double Opacity, struct FLinearColor* GoldTeam);
	void GetAllColors(double Opacity, struct FLinearColor* White, struct FLinearColor* Dark, struct FLinearColor* Red, struct FLinearColor* Yellow, struct FLinearColor* Blue, struct FLinearColor* Green, const struct FLinearColor& K2Node_MakeStruct_LinearColor, const struct FLinearColor& CallFunc_Multiply_LinearColorLinearColor_ReturnValue, const struct FLinearColor& CallFunc_Multiply_LinearColorLinearColor_ReturnValue_1, const struct FLinearColor& CallFunc_Multiply_LinearColorLinearColor_ReturnValue_2, const struct FLinearColor& CallFunc_Multiply_LinearColorLinearColor_ReturnValue_3, const struct FLinearColor& CallFunc_Multiply_LinearColorLinearColor_ReturnValue_4, const struct FLinearColor& CallFunc_Multiply_LinearColorLinearColor_ReturnValue_5, float K2Node_MakeStruct_A_ImplicitCast);
};
