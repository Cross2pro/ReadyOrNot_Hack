...
public:
	...
	uint8                                        Pad_35C[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<enum class EDebugLogType, class FString> LogCategorySpecifiers;                             // 0x98(0x50)(Edit, Config, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_361[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
