...
{
public:
	int32                                        Major;                                             // 0x0(0x4)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        Minor;                                             // 0x4(0x4)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        Build;                                             // 0x8(0x4)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_E82[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FStreamlineVersion                    DetectedDriverVersion;                             // 0x28(0xC)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
