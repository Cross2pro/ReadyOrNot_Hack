...
struct UANIMBP_SPC9_C_AnimGraph_Params
{
public:
...
struct UANIMBP_SPC9_C_BlueprintUpdateAnimation_Params
{
public:
...
struct UANIMBP_SPC9_C_ExecuteUbergraph_ANIMBP_SPC9_Params
{
public:
	...
	uint8                                        Pad_3480[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	float                                        K2Node_StructMemberSet_Alpha_ImplicitCast;         // 0x4C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
