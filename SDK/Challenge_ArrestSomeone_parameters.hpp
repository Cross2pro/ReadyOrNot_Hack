...
{
public:
	class AReadyOrNotGameState*                  Gs;                                                // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class AReadyOrNotCharacter*                  ArrestedBy;                                        // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class AReadyOrNotCharacter*                  K2Node_CustomEvent_Character;                      // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AReadyOrNotCharacter*                  K2Node_CustomEvent_ArrestedBy;                     // 0x10(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate;              // 0x18(0x10)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AReadyOrNotGameState*                  K2Node_Event_gs;                                   // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
