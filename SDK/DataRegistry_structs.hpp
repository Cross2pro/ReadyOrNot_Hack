...
{
public:
	uint8                                        Pad_DB4[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_DD0[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DD4[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
