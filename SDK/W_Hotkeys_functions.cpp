...
// class AReadyOrNotCharacter*        K2Node_CustomEvent_Character_1                                   (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class ABaseItem*                   K2Node_CustomEvent_LastItemBeforeQuickThrow                      (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class ABaseItem*                   K2Node_CustomEvent_QuickThrowGrenade_1                           (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class ABaseItem*                   K2Node_CustomEvent_QuickThrowGrenade                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_CustomEvent_bUsingSecondarySight                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ABaseMagazineWeapon*         K2Node_CustomEvent_Weapon                                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class AReadyOrNotCharacter*        K2Node_CustomEvent_Character                                     (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_CustomEvent_bOn                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_EquippedWeaponHasLaserAttachment_ReturnValue            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_EquippedWeaponHasLightAttachment_ReturnValue            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
