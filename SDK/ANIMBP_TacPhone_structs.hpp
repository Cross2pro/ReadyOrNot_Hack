...
// 0x0 (0x1 - 0x1)
// ScriptStruct ANIMBP_TacPhone.ANIMBP_TacPhone_C.AnimBlueprintGeneratedMutableData
...
// 0xCF (0xD0 - 0x1)
// ScriptStruct ANIMBP_TacPhone.ANIMBP_TacPhone_C.AnimBlueprintGeneratedConstantData
...
public:
	...
	class FName                                  __NameProperty_20;                                 // 0xC(0x8)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3338[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAnimNodeFunctionRef                  __StructProperty_21;                               // 0x18(0x20)(BlueprintVisible, NoDestructor)
