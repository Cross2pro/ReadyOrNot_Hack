...
void UUMG_RadialMenu_C::Is_in_Deadzone(bool* InDeadZone)
{
	...
	Params::UUMG_RadialMenu_C_Is_in_Deadzone_Params Parms{};
...
void UUMG_RadialMenu_C::SetCursorColor(bool Visible, double CallFunc_SelectFloat_ReturnValue, const struct FLinearColor& CallFunc_K2_GetVectorParameterValue_ReturnValue, float CallFunc_BreakColor_R, float CallFunc_BreakColor_G, float CallFunc_BreakColor_B, float CallFunc_BreakColor_A, const struct FLinearColor& CallFunc_MakeColor_ReturnValue, float CallFunc_MakeColor_A_ImplicitCast)
{
	static class UFunction* Func = nullptr;
	...
	Params::UUMG_RadialMenu_C_SetCursorColor_Params Parms{};
...
void UUMG_RadialMenu_C::RemoveAllChildren(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, class UUserWidget* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UUMG_RadialMenu_C_RemoveAllChildren_Params Parms{};
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// class UMaterialInstanceDynamic*    RadialMaterial                                                   (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// TScriptInterface<class IIRadialSlot_C>K2Node_DynamicCast_AsIRadial_Slot_2                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UUMG_RadialMenu_C::GetSelectedWidget(class UUserWidget** Output, bool CallFunc_Array_IsValidIndex_ReturnValue, class UUserWidget* CallFunc_Array_Get_Item)
{
	static class UFunction* Func = nullptr;
...
// bool                               CallFunc_Viewport__GetMousePosition_ReturnValue                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
