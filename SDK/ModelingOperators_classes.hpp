...
public:
	...
	uint8                                        Pad_F98[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FBC[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FC3[0x108];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_FE0[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FE3[0x168];                                    // Fixing Size Of Struct [ Dumper-7 ]
