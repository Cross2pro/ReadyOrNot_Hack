...
{
public:
	uint8                                        Pad_D5A[0x88];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D5B[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_D5F[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_D62[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
