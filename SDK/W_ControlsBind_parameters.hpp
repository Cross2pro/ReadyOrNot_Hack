...
struct UW_ControlsBind_C_SetupDescription_Params
{
public:
...
struct UW_ControlsBind_C_Click_Listener_Button_Down_Params
{
public:
	...
	struct FEventReply                           CallFunc_HandleMouseButtonDown_Reply;              // 0x220(0xB8)(None)
};
...
public:
	...
	class UW_ControlsBind_C*                     TempActionToRemove;                                // 0x20(0x8)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UW_ControlsBind_C*                     TempAxisToRemove;                                  // 0x28(0x8)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	double                                       Scale;                                             // 0x18(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                       TempScale;                                         // 0x40(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	double                                       ControlsScale;                                     // 0x30(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FName                                  TempMappingName;                                   // 0x38(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	float                                        CallFunc_PointerEvent_GetWheelDelta_ReturnValue;   // 0x16C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FKey                                  Temp_struct_Variable;                              // 0x170(0x18)(HasGetValueTypeHash)
	bool                                         CallFunc_Greater_DoubleDouble_ReturnValue;         // 0x188(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable_1;                              // 0x189(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1D7B[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FKey                                  Temp_struct_Variable_1;                            // 0x190(0x18)(HasGetValueTypeHash)
	struct FKey                                  Temp_struct_Variable_2;                            // 0x1A8(0x18)(HasGetValueTypeHash)
	struct FKey                                  K2Node_Select_Default;                             // 0x1C0(0x18)(HasGetValueTypeHash)
	struct FEventReply                           CallFunc_Handled_ReturnValue;                      // 0x1D8(0xB8)(None)
	struct FKey                                  K2Node_Select_Default_1;                           // 0x290(0x18)(HasGetValueTypeHash)
	struct FEventReply                           CallFunc_Unhandled_ReturnValue;                    // 0x2A8(0xB8)(None)
	double                                       CallFunc_Greater_DoubleDouble_A_ImplicitCast;      // 0x360(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	TArray<struct FAxisMappingStruct>            Axes;                                              // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	TArray<struct FActionMappingStruct>          Actions;                                           // 0x10(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	bool                                         bHasConflict;                                      // 0x20(0x1)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FKeyEvent                             In_Key_Event;                                      // 0x38(0x40)(BlueprintVisible, BlueprintReadOnly, Parm)
...
public:
	...
	struct FEventReply                           ReturnValue;                                       // 0x78(0xB8)(Parm, OutParm, ReturnParm)
	struct FEventReply                           CallFunc_HandleKeyDown_ReturnValue;                // 0x130(0xB8)(None)
};
...
public:
	...
	struct FEventReply                           Reply;                                             // 0x78(0xB8)(Parm, OutParm)
	struct FKey                                  CallFunc_PointerEvent_GetEffectingButton_ReturnValue; // 0x130(0x18)(HasGetValueTypeHash)
	struct FEventReply                           CallFunc_Handled_ReturnValue;                      // 0x148(0xB8)(None)
	struct FEventReply                           CallFunc_Unhandled_ReturnValue;                    // 0x200(0xB8)(None)
};
...
public:
	...
	struct FPointerEvent                         MouseEvent;                                        // 0x38(0x78)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	struct FEventReply                           ReturnValue;                                       // 0xB0(0xB8)(Parm, OutParm, ReturnParm)
	struct FEventReply                           CallFunc_HandleMouseWheel_ReturnValue;             // 0x168(0xB8)(None)
};
...
public:
	...
	struct FPointerEvent                         MouseEvent;                                        // 0x38(0x78)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	struct FEventReply                           ReturnValue;                                       // 0xB0(0xB8)(Parm, OutParm, ReturnParm)
	struct FEventReply                           CallFunc_HandleMouseButtonDown_Reply;              // 0x168(0xB8)(None)
};
...
public:
	...
	struct FKey                                  K2Node_CustomEvent_KeyIn;                          // 0x8(0x18)(HasGetValueTypeHash)
	struct FFMODEventInstance                    CallFunc_PlayEvent2D_ReturnValue;                  // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Key_IsGamepadKey_ReturnValue;             // 0x28(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2353[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAxisMappingStruct                    K2Node_MakeStruct_AxisMappingStruct;               // 0x30(0x28)(None)
	struct FActionMappingStruct                  K2Node_MakeStruct_ActionMappingStruct;             // 0x58(0x28)(None)
	TArray<enum class EActionMappingFilter>      K2Node_MakeArray_Array;                            // 0x80(0x10)(ReferenceParm)
	TArray<enum class EAxisMappingFilter>        K2Node_MakeArray_Array_1;                          // 0x90(0x10)(ReferenceParm)
	bool                                         CallFunc_GetAllActionMappings_ReturnValue;         // 0xA0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2355[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FActionMappingStruct>          CallFunc_GetAllActionMappings_ActionMappings;      // 0xA8(0x10)(ReferenceParm)
	bool                                         CallFunc_GetAllAxisMappings_ReturnValue;           // 0xB8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2358[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FAxisMappingStruct>            CallFunc_GetAllAxisMappings_AxisMappings;          // 0xC0(0x10)(ReferenceParm)
	int32                                        CallFunc_Array_Length_ReturnValue;                 // 0xD0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_GetConflictingKeybindsWhenValid_HasConflict; // 0xD4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_235D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FAxisMappingStruct>            CallFunc_GetConflictingKeybindsWhenValid_ConflictingAxes; // 0xD8(0x10)(ReferenceParm)
	TArray<struct FActionMappingStruct>          CallFunc_GetConflictingKeybindsWhenValid_ConflictingActions; // 0xE8(0x10)(ReferenceParm)
	...
	class FText                                  CallFunc_CheckConflictingKeybindsAreUnbindable_ReturnValue; // 0x100(0x18)(None)
	bool                                         CallFunc_TextIsEmpty_ReturnValue;                  // 0x118(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_LessEqual_IntInt_ReturnValue_1;           // 0x120(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         Temp_bool_Variable;                                // 0x123(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2391[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  K2Node_CustomEvent_BindFriendlyName;               // 0x128(0x18)(None)
	class FText                                  CallFunc_GetConflictingKeybindText_ReturnValue;    // 0x140(0x18)(None)
	...
	bool                                         K2Node_Event_IsDesignTime;                         // 0x169(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_RebindKey_ReturnValue;                    // 0x16A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Array_Contains_ReturnValue;               // 0x16B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Array_Contains_ReturnValue_1;             // 0x16C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_BooleanOR_ReturnValue;                    // 0x16D(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_BooleanOR_ReturnValue_1;                  // 0x16E(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2399[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAxisMappingStruct                    CallFunc_GetInputBindingData_AxisMapping;          // 0x170(0x28)(None)
	struct FActionMappingStruct                  CallFunc_GetInputBindingData_ActionMapping;        // 0x198(0x28)(None)
	struct FAxisMappingStruct                    K2Node_MakeStruct_AxisMappingStruct_1;             // 0x1C0(0x28)(None)
	struct FActionMappingStruct                  K2Node_MakeStruct_ActionMappingStruct_1;           // 0x1E8(0x28)(None)
};
