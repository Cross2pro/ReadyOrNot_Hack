...
void UW_Customization_Slot_C::SetCustomIconTexture(class UTexture2D* IconTexture, bool MatchSize, const struct FVector2D& CustomSize, const struct FLinearColor& ColorAndOpacity, const struct FDeprecateSlateVector2D& K2Node_SetFieldsInStruct_ImageSize_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
// double                             CallFunc_GetWidthByShape_Width                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                             CallFunc_GetHeightByShape_Height                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UW_Customization_Slot_C::ShowMissingData(bool NoData, double LineThickness, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue, float CallFunc_K2_GetScalarParameterValue_ReturnValue, bool CallFunc_IsValid_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, double CallFunc_GetWidthByShape_Width, double CallFunc_GetHeightByShape_Height, double CallFunc_FMax_ReturnValue, double CallFunc_Divide_DoubleDouble_ReturnValue, double CallFunc_Subtract_DoubleDouble_ReturnValue, double CallFunc_Add_DoubleDouble_ReturnValue, const struct FLinearColor& CallFunc_GetColorByName_LinearColor, const struct FSlateColor& CallFunc_GetColorByName_SlateColor, double CallFunc_Multiply_DoubleDouble_ReturnValue, double CallFunc_GetWidthByShape_Width_1, double CallFunc_GetHeightByShape_Height_1, const struct FVector2D& CallFunc_MakeVector2D_ReturnValue, double K2Node_VariableSet_SlashLineThickness_ImplicitCast, float CallFunc_SetScalarParameterValue_Value_ImplicitCast)
{
	...
	Parms.K2Node_VariableSet_SlashLineThickness_ImplicitCast = K2Node_VariableSet_SlashLineThickness_ImplicitCast;
...
// struct FLinearColor                CallFunc_SelectColor_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_NotEqual_SoftObjectReference_ReturnValue_1              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UW_Customization_Slot_C::GetWidthByShape(double* Width, enum class E_BoxShape Temp_byte_Variable, double CallFunc_Divide_DoubleDouble_ReturnValue, double CallFunc_Subtract_DoubleDouble_ReturnValue, double K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UW_Customization_Slot_C::GetHeightByShape(double* Height, enum class E_BoxShape Temp_byte_Variable, double CallFunc_Divide_DoubleDouble_ReturnValue, double CallFunc_Subtract_DoubleDouble_ReturnValue, double K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UW_Customization_Slot_C::OnAddedToFocusPath(const struct FFocusEvent& InFocusEvent)
{
	...
	Params::UW_Customization_Slot_C_OnAddedToFocusPath_Params Parms{};
...
void UW_Customization_Slot_C::OnFocusLost(const struct FFocusEvent& InFocusEvent)
{
	...
	Params::UW_Customization_Slot_C_OnFocusLost_Params Parms{};
...
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_CustomEvent_Toggleable                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_CustomEvent_Highlight                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
