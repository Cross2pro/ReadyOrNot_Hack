...
// class UW_Loadout_Preset_Preview_SubItem_C*CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_GetAttachmentInfo_IsNull                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UVerticalBox*                CallFunc_FindParentWidgetOfType_ReturnValue                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// enum class ESlateVisibility        K2Node_Select_Default                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UVerticalBoxSlot*            CallFunc_AddChildToVerticalBox_ReturnValue                       (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void UW_Loadout_Preset_Preview_C::PopulateAttachmentList(class UVerticalBox* VerticalBox, TArray<class UClass*>& AttachmentObjects, enum class ESlateVisibility Temp_byte_Variable, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UW_Loadout_Preset_Preview_SubItem_C* CallFunc_Create_ReturnValue, const struct FMargin& K2Node_MakeStruct_Margin, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, bool Temp_bool_Variable, class UClass* CallFunc_Array_Get_Item, bool CallFunc_GetAttachmentInfo_IsNull, class FText CallFunc_GetAttachmentInfo_Name, class FText CallFunc_GetAttachmentInfo_Type, enum class ESlateVisibility Temp_byte_Variable_1, bool CallFunc_HasAnyChildren_ReturnValue, class UVerticalBox* CallFunc_FindParentWidgetOfType_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UClass*                      MunitionItem                                                     (Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UW_Loadout_Preset_Preview_C::ExecuteUbergraph_W_Loadout_Preset_Preview(int32 EntryPoint, const struct FSavedLoadout& K2Node_Event_ActiveLoadout, bool CallFunc_IsValidClass_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue, TMap<enum class EItemCategory, class UClass*> K2Node_Event_ItemCategory, class FName K2Node_Event_OptionNameID, bool K2Node_Event_IsGamepad, class FName K2Node_Event_PageName, const struct FSavedLoadout& K2Node_CustomEvent_SavedLoadout, double K2Node_Event_Delay_1, double K2Node_Event_Delay, bool K2Node_Event_Collapse, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_1, float CallFunc_Delay_Duration_ImplicitCast)
{
	static class UFunction* Func = nullptr;
