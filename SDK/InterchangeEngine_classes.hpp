...
{
public:
	struct FInterchangeContentImportSettings     ContentImportSettings;                             // 0x38(0x128)(Edit, Config, NativeAccessSpecifierPublic)
...
{
public:
	struct FSoftObjectPath                       SceneImportAsset;                                  // 0x28(0x20)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1BD3[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1E35[0xB0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1E93[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
