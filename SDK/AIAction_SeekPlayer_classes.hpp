...
public:
	...
	class USeekPlayerCombatMove_C*               SeekPlayerCombatMove;                              // 0x60(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
