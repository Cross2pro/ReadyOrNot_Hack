...
class UClass* UANIMBP_G19G5_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ANIMBP_G19G5_C");

	return Clss;
}


// ANIMBP_G19G5_C ANIMBP_G19G5.Default__ANIMBP_G19G5_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UANIMBP_G19G5_C* UANIMBP_G19G5_C::GetDefaultObj()
{
	static class UANIMBP_G19G5_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UANIMBP_G19G5_C*>(UANIMBP_G19G5_C::StaticClass()->DefaultObject);
...
void UANIMBP_G19G5_C::AnimGraph(struct FPoseLink* AnimGraph)
{
	...
	Params::UANIMBP_G19G5_C_AnimGraph_Params Parms{};
...
void UANIMBP_G19G5_C::BlueprintUpdateAnimation(float DeltaTimeX)
{
	...
	Params::UANIMBP_G19G5_C_BlueprintUpdateAnimation_Params Parms{};
...
void UANIMBP_G19G5_C::ExecuteUbergraph_ANIMBP_G19G5(int32 EntryPoint, class AActor* CallFunc_GetOwningActor_ReturnValue, class ABaseMagazineWeapon* K2Node_DynamicCast_AsBase_Magazine_Weapon, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_Round_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, float K2Node_Event_DeltaTimeX, double CallFunc_Round_A_ImplicitCast)
{
	...
	Params::UANIMBP_G19G5_C_ExecuteUbergraph_ANIMBP_G19G5_Params Parms{};
