...
struct UAG_IsLeavingSurrenderedState_C_CanOpen_Params
{
public:
	...
	bool                                         CallFunc_IsExitingSurrender_ReturnValue;           // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
