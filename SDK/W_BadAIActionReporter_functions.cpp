...
// class ABadAIAction*                CallFunc_GetMostRecentBadAIActionReport_ReturnValue              (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_RemoveBadAIActionReport_ReturnValue                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_TextIsEmpty_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ABadAIAction*                CallFunc_GetMostRecentBadAIActionReport_ReturnValue_1            (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Not_PreBool_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class ABadAIAction*                CallFunc_GetMostRecentBadAIActionReport_ReturnValue_2            (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UW_Button_C*                 K2Node_ComponentBoundEvent_Button                                (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_ReportBadAIAction_ReturnValue                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
