...
void UBP_RosterSelectionFunctionLibrary_C::GetStressLevelColor(double StressLevel, class UObject* __WorldContext, struct FSlateColor* Color, TMap<struct FVector2D, struct FSlateColor> StressColorsMap, TMap<struct FVector2D, class FText> StressLevelsMap, const struct FVector2D& CurrentRange, TMap<struct FVector2D, class FText> K2Node_MakeVariable_MakeVariableOutput, bool Temp_bool_True_if_break_was_hit_Variable, int32 Temp_int_Array_Index_Variable, bool CallFunc_Not_PreBool_ReturnValue, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<struct FVector2D>& CallFunc_Map_Keys_Keys, TMap<struct FVector2D, struct FSlateColor> K2Node_MakeVariable_MakeVariableOutput_1, const struct FVector2D& CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Array_IsValidIndex_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, double CallFunc_BreakVector2D_X, double CallFunc_BreakVector2D_Y, const struct FSlateColor& CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, bool CallFunc_InRange_FloatFloat_ReturnValue)
{
...
// double                             CallFunc_GetStressLevelText_StressLevel_ImplicitCast             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                             CallFunc_GetStressLevelColor_StressLevel_ImplicitCast            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_RosterSelectionFunctionLibrary_C::StressPercentageAsStatus(class URosterCharacter* Character, class UObject* __WorldContext, class FText* StatusText, struct FSlateColor* StatusColor, enum class ERosterCharacterState Temp_byte_Variable, const struct FSlateColor& CallFunc_GetStressLevelColor_Color, class FText CallFunc_GetStressLevelText_Text, const struct FSlateColor& K2Node_MakeStruct_SlateColor, const struct FSlateColor& K2Node_Select_Default, double CallFunc_GetStressLevelText_StressLevel_ImplicitCast, double CallFunc_GetStressLevelColor_StressLevel_ImplicitCast)
{
	static class UFunction* Func = nullptr;
	...
	Parms.K2Node_Select_Default = K2Node_Select_Default;
	Parms.CallFunc_GetStressLevelText_StressLevel_ImplicitCast = CallFunc_GetStressLevelText_StressLevel_ImplicitCast;
	Parms.CallFunc_GetStressLevelColor_StressLevel_ImplicitCast = CallFunc_GetStressLevelColor_StressLevel_ImplicitCast;
...
void UBP_RosterSelectionFunctionLibrary_C::StressPercentageAsText(class URosterCharacter* Character, class UObject* __WorldContext, class FText* Text, class FText CallFunc_Conv_DoubleToText_ReturnValue, double CallFunc_Conv_DoubleToText_Value_ImplicitCast)
{
	static class UFunction* Func = nullptr;
