...
struct APrimary_SawnOff_C_ReceiveTick_Params
{
public:
...
struct APrimary_SawnOff_C_OnAttachmentActivated_Event_0_Params
{
public:
...
struct APrimary_SawnOff_C_OnAttachmentDeactivated_Event_0_Params
{
public:
	enum class EItemAttachment                   AttachmentChanged;                                 // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct APrimary_SawnOff_C_ExecuteUbergraph_Primary_SawnOff_Params
{
public:
