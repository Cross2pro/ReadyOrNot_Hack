...
class UWidget* UW_Loadout_Page_WeaponEdit_C::BP_GetDesiredFocusTarget(TScriptInterface<class IReadyOrNotUI_C> K2Node_DynamicCast_AsReady_or_Not_UI, bool K2Node_DynamicCast_bSuccess, class UWidget* CallFunc_GetFocusTarget_Focus, bool CallFunc_IsValid_ReturnValue, TScriptInterface<class IReadyOrNotUI_C> K2Node_DynamicCast_AsReady_or_Not_UI_1, bool K2Node_DynamicCast_bSuccess_1, class UWidget* CallFunc_GetFocusTarget_Focus_1)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class ABaseWeapon*                 WeaponObject                                                     (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// class AReadyOrNotGameState*        CallFunc_GetReadyOrNotGameState_ReturnValue                      (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// TSubclassOf<class UWeaponAttachment>CallFunc_GetActivePrimaryAttachmentByType_ReturnValue            (ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
// TSubclassOf<class UWeaponAttachment>CallFunc_GetActiveSecondaryAttachmentByType_ReturnValue          (ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
// TSubclassOf<class UWeaponAttachment>K2Node_Select_Default                                            (ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
// class UWeaponAttachment*           CallFunc_GetClassDefaultObject_ReturnValue                       (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// bool                               Temp_bool_Variable                                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AReadyOrNotGameState*        CallFunc_GetReadyOrNotGameState_ReturnValue                      (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UWeaponAttachment*           CallFunc_GetDefaultAttachmentByType_Attachment                   (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UWeaponAttachment*           CallFunc_GetStoredAttachmentByWeaponAndType_ReturnValue          (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UWeaponAttachment*           K2Node_Select_Default                                            (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UW_Loadout_Page_WeaponEdit_C::InitializeByPageID(const class FString& CallFunc_Conv_NameToString_ReturnValue, class AReadyOrNotGameState* CallFunc_GetReadyOrNotGameState_ReturnValue, bool K2Node_SwitchName_CmpSuccess, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// bool                               K2Node_CustomEvent_Secondary                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UClass*                      K2Node_CustomEvent_Weapon                                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UWeaponAttachment*           K2Node_ComponentBoundEvent_Attachment                            (ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
// class UW_LoadoutSlot_v2_C*         K2Node_ComponentBoundEvent_TriggeringSlot_3                      (ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
// TSubclassOf<class UWeaponAttachment>K2Node_ComponentBoundEvent_AttachmentClass                       (ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
// class UW_LoadoutSlot_v2_C*         K2Node_ComponentBoundEvent_TriggeringSlot_1                      (ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
// class UFMODEvent*                  K2Node_Select_Default                                            (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// Function W_Loadout_Page_WeaponEdit.W_Loadout_Page_WeaponEdit_C.OnItemUpdated__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:

void UW_Loadout_Page_WeaponEdit_C::OnItemUpdated__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("W_Loadout_Page_WeaponEdit_C", "OnItemUpdated__DelegateSignature");
...
// Function W_Loadout_Page_WeaponEdit.W_Loadout_Page_WeaponEdit_C.OnCurrentWeaponHovered__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:

void UW_Loadout_Page_WeaponEdit_C::OnCurrentWeaponHovered__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("W_Loadout_Page_WeaponEdit_C", "OnCurrentWeaponHovered__DelegateSignature");
