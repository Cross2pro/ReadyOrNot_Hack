...
{
public:
	uint8                                        Pad_2B5[0x54];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B7[0xA8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2BB[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2BE[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2CD[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2D4[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2D6[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2DA[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
