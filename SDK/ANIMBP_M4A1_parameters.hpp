...
struct UANIMBP_M4A1_C_AnimGraph_Params
{
public:
...
struct UANIMBP_M4A1_C_BlueprintUpdateAnimation_Params
{
public:
...
struct UANIMBP_M4A1_C_ExecuteUbergraph_ANIMBP_M4A1_Params
{
public:
	...
	bool                                         CallFunc_InSingleMode_ReturnValue;                 // 0x31(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APlayerCharacter*                      K2Node_DynamicCast_AsPlayer_Character;             // 0x50(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_1202[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	double                                       CallFunc_Round_A_ImplicitCast;                     // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_StructMemberSet_Alpha_ImplicitCast;         // 0x68(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
