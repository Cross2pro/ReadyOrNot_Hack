...
class UANIMBP_P99_C : public URoNWeaponAnimInstance
{
public:
	...
	void ExecuteUbergraph_ANIMBP_P99(int32 EntryPoint, int32 CallFunc_Round_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, double CallFunc_Round_A_ImplicitCast);
};
