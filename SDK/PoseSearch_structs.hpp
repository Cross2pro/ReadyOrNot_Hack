...
{
public:
	uint8                                        Pad_1054[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FBoneReference                        Reference;                                         // 0x0(0x10)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	int32                                        Flags;                                             // 0x10(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        Weight;                                            // 0x14(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                          DebugColor;                                        // 0x18(0x10)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_10A1[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10A4[0x220];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10A8[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1105[0xF4];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_111A[0x80];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_111C[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_111D[0x67];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
