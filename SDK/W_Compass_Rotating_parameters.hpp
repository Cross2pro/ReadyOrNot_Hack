...
struct UW_Compass_Rotating_C_Tick_Params
{
public:
...
struct UW_Compass_Rotating_C_ExecuteUbergraph_W_Compass_Rotating_Params
{
public:
	...
	float                                        CallFunc_ClampAxis_ReturnValue;                    // 0x70(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_NegateFloat_ReturnValue;                  // 0x74(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
