...
struct UAC_RecentFriendlyStun_C_Score_Params
{
public:
	...
	double                                       CallFunc_MapRangeClamped_InRangeA_ImplicitCast;    // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
