...
void UW_Briefing_Media_GalleryEntry_C::OnSelect__DelegateSignature(class UW_Briefing_Media_GalleryEntry_C* Gallery_Entry)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("W_Briefing_Media_GalleryEntry_C", "OnSelect__DelegateSignature");

	Params::UW_Briefing_Media_GalleryEntry_C_OnSelect__DelegateSignature_Params Parms{};
