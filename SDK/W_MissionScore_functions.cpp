...
// class AScoringManager*             CallFunc_Get_ReturnValue                                         (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_HasClearedMission_bHasClearedMission                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_HasClearedMission_bSoftClearedMission                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_HasClearedMission_bMissionFailed                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FBasicLevelStats            CallFunc_LoadLevelStats_OutStats                                 (NoDestructor)
// struct FGameplayTag                CallFunc_LoadLevelStats_OutDifficultyTag                         (NoDestructor, HasGetValueTypeHash)
...
void UW_MissionScore_C::UpdateLevelStats(class UDifficultySubsystem* CallFunc_GetEngineSubsystem_ReturnValue, class AScoringManager* CallFunc_Get_ReturnValue, bool CallFunc_HasClearedMission_bHasClearedMission, bool CallFunc_HasClearedMission_bSoftClearedMission, bool CallFunc_HasClearedMission_bMissionFailed, const struct FBasicLevelStats& CallFunc_LoadLevelStats_OutStats, const struct FGameplayTag& CallFunc_LoadLevelStats_OutDifficultyTag, bool CallFunc_BooleanOR_ReturnValue, const struct FDifficultyData& CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_EqualEqual_DoubleDouble_ReturnValue, const class FString& CallFunc_TimeSecondsToString_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue, const class FString& CallFunc_CalculateGradeLetterFromPercentage_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue_1, class AScoringManager* CallFunc_Get_ReturnValue_1, float CallFunc_GetCurrentScoreAsPercentage_ReturnValue, const struct FBasicLevelStats& K2Node_MakeStruct_BasicLevelStats, bool CallFunc_SaveLevelStats_NewBestRating, bool CallFunc_SaveLevelStats_NewBestTime, float K2Node_MakeStruct_BestTime_ImplicitCast, double CallFunc_EqualEqual_DoubleDouble_B_ImplicitCast)
{
	...
	Parms.CallFunc_LoadLevelStats_OutDifficultyTag = CallFunc_LoadLevelStats_OutDifficultyTag;
	...
	Parms.K2Node_MakeStruct_BestTime_ImplicitCast = K2Node_MakeStruct_BestTime_ImplicitCast;
...
// class AGS_COOP_C*                  K2Node_DynamicCast_AsGS_COOP                                     (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Greater_DoubleDouble_ReturnValue                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                             CallFunc_Greater_DoubleDouble_A_ImplicitCast                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

enum class ESlateVisibility UW_MissionScore_C::GetMissionNextMapTimerVisibility(class AReadyOrNotGameState* CallFunc_GetReadyOrNotGameState_ReturnValue, class AGS_COOP_C* K2Node_DynamicCast_AsGS_COOP, bool K2Node_DynamicCast_bSuccess, bool CallFunc_Greater_DoubleDouble_ReturnValue, double CallFunc_Greater_DoubleDouble_A_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
// class UW_MissionEndBonus_C*        CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// int32                              Total                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              Score                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UW_MissionScore_ScorePanel_Entry_C*CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// class AScoringManager*             CallFunc_Get_ReturnValue_2                                       (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// class AScoringManager*             CallFunc_Get_ReturnValue_3                                       (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// TArray<struct FScorePenaltyData>   CallFunc_GetPenaltyScoreGroups_ReturnValue                       (ReferenceParm)
// bool                               CallFunc_Array_IsValidIndex_ReturnValue                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FString                      CallFunc_TimeSecondsToString_ReturnValue                         (ZeroConstructor, HasGetValueTypeHash)
// class FText                        CallFunc_Conv_StringToText_ReturnValue                           (None)
// TScriptInterface<class IReadyOrNotUI_C>K2Node_DynamicCast_AsReady_or_Not_UI_1                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess_2                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class APlayerController*           CallFunc_GetPlayerController_ReturnValue                         (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// double                             K2Node_VariableSet_TimeElapsed_ImplicitCast                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UW_MissionScore_C::ExecuteUbergraph_W_MissionScore(int32 EntryPoint, class AScoringManager* CallFunc_Get_ReturnValue, bool CallFunc_HasClearedMission_bHasClearedMission, bool CallFunc_HasClearedMission_bSoftClearedMission, bool CallFunc_HasClearedMission_bMissionFailed, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, class AGameStateBase* CallFunc_GetGameState_ReturnValue, class ACoopGS* K2Node_DynamicCast_AsCoop_GS, bool K2Node_DynamicCast_bSuccess, class AScoringManager* CallFunc_Get_ReturnValue_1, int32 CallFunc_GetTotalScore_TotalScore, class AScoringManager* CallFunc_Get_ReturnValue_2, const class FString& CallFunc_CalculateGradeLetterFromPlayerScore_ReturnValue, class AMapStatisticsSystem* CallFunc_GetMapStatistics_ReturnValue, bool CallFunc_IsValid_ReturnValue, TScriptInterface<class IReadyOrNotUI_C> K2Node_DynamicCast_AsReady_or_Not_UI, bool K2Node_DynamicCast_bSuccess_1, class AScoringManager* CallFunc_Get_ReturnValue_3, TArray<struct FScorePenaltyData>& CallFunc_GetPenaltyScoreGroups_ReturnValue, bool CallFunc_Array_IsValidIndex_ReturnValue, const class FString& CallFunc_TimeSecondsToString_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue, TScriptInterface<class IReadyOrNotUI_C> K2Node_DynamicCast_AsReady_or_Not_UI_1, bool K2Node_DynamicCast_bSuccess_2, class APlayerController* CallFunc_GetPlayerController_ReturnValue, double K2Node_VariableSet_TimeElapsed_ImplicitCast, float CallFunc_TimeSecondsToString_InSeconds_ImplicitCast)
{
	...
	Parms.K2Node_VariableSet_TimeElapsed_ImplicitCast = K2Node_VariableSet_TimeElapsed_ImplicitCast;
