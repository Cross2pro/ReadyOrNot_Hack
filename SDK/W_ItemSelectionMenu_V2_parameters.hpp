...
struct UW_ItemSelectionMenu_V2_C_Get_Item_Categories_Params
{
public:
	class AReadyOrNotCharacter*                  Self2;                                             // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<struct FItemSelectionGroup>           ItemSelectionGroups;                               // 0x8(0x10)(Parm, OutParm)
...
public:
	...
	class UW_ItemSelection_ItemList_V2_C*        CallFunc_Get_List_At_Index_Return_Value;           // 0x10(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	TArray<struct FItemSelectionGroup>           CallFunc_Get_Item_Categories_ItemSelectionGroups;  // 0x20(0x10)(ReferenceParm)
	...
	struct FFMODEventInstance                    CallFunc_PlayEvent2D_ReturnValue;                  // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         CallFunc_IsInViewport_ReturnValue;                 // 0x49(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	bool                                         K2Node_CustomEvent_bForce;                         // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
