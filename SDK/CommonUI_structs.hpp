...
public:
	...
	enum class EMouseLockMode                    MouseLockMode;                                     // 0x4(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bHideCursorDuringViewportCapture;                  // 0x5(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
};
...
public:
	...
	uint8                                        Pad_241E[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2422[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2425[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           OverrideBrush;                                     // 0x30(0xD0)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FCommonInputTypeInfo                  KeyboardInputTypeInfo;                             // 0x40(0x100)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                  DefaultGamepadInputTypeInfo;                       // 0x140(0x100)(Edit, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, struct FCommonInputTypeInfo> GamepadInputOverrides;                             // 0x240(0x50)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                  TouchInputTypeInfo;                                // 0x290(0x100)(Edit, Protected, NativeAccessSpecifierProtected)
};
