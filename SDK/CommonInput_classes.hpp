...
public:
	...
	uint8                                        Pad_A23[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_A2A[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	bool                                         bEnableAutomaticGamepadTypeDetection;              // 0xDB(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_B33[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B51[0x17];                                     // Fixing Size Of Struct [ Dumper-7 ]
