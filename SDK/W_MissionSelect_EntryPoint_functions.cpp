...
void UW_MissionSelect_EntryPoint_C::SetImageVisibility(enum class ESlateVisibility InVisibility)
{
	static class UFunction* Func = nullptr;
	...
	Params::UW_MissionSelect_EntryPoint_C_SetImageVisibility_Params Parms{};
