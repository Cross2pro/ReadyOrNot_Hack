...
// bool                               CallFunc_GetTrait_bIsUnlocked                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class URosterTrait*                CallFunc_GetTrait_ReturnValue                                    (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UW_Roster_Status_Card_C::UpdateSpecialty(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, double Temp_real_Variable, bool CallFunc_IsValid_ReturnValue, bool CallFunc_GetTrait_bIsUnlocked, class URosterTrait* CallFunc_GetTrait_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, enum class ESlateVisibility K2Node_Select_Default, bool Temp_bool_Variable_1, double Temp_real_Variable_1, double K2Node_Select_Default_1, float CallFunc_SetRenderOpacity_InOpacity_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
void UW_Roster_Status_Card_C::InitLayout(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility K2Node_Select_Default, float CallFunc_SetWidthOverride_InWidthOverride_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
void UW_Roster_Status_Card_C::SetupAptitude(class UProgressBar* ProgressBar, class UTextBlock* TextBlock, double Percent, double CallFunc_Multiply_DoubleDouble_ReturnValue, int32 CallFunc_Round_ReturnValue, class FText CallFunc_Conv_IntToText_ReturnValue, float CallFunc_SetPercent_InPercent_ImplicitCast)
{
	static class UFunction* Func = nullptr;
