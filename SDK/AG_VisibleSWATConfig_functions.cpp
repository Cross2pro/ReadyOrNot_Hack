...
class UClass* UAG_VisibleSWATConfig_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AG_VisibleSWATConfig_C");

	return Clss;
}


// AG_VisibleSWATConfig_C AG_VisibleSWATConfig.Default__AG_VisibleSWATConfig_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAG_VisibleSWATConfig_C* UAG_VisibleSWATConfig_C::GetDefaultObj()
{
	static class UAG_VisibleSWATConfig_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAG_VisibleSWATConfig_C*>(UAG_VisibleSWATConfig_C::StaticClass()->DefaultObject);
...
bool UAG_VisibleSWATConfig_C::CanOpen(struct FAIActionDecisionContext& Context, class UReadyOrNotAIConfig* CallFunc_Get_ReturnValue, float CallFunc_GetFloat_ReturnValue, class ACyberneticCharacter* CallFunc_GetCharacter_ReturnValue, float CallFunc_GetVisibleSWATPercentage_ReturnValue, bool CallFunc_GreaterEqual_DoubleDouble_ReturnValue, double CallFunc_GreaterEqual_DoubleDouble_B_ImplicitCast, double CallFunc_GreaterEqual_DoubleDouble_A_ImplicitCast)
{
	...
	Params::UAG_VisibleSWATConfig_C_CanOpen_Params Parms{};
