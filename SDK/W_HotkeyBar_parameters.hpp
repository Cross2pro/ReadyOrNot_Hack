...
public:
	...
	class UW_HotkeyBar_Entry_C*                  K2Node_CustomEvent_TriggeringHotkeyEntry;          // 0xC0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UW_HotkeyBar_Entry_C*                  CallFunc_Create_ReturnValue;                       // 0xC8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UW_HotkeyBar_Entry_C*                  CallFunc_Array_Get_Item_1;                         // 0xE0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
