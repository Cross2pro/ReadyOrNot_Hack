...
class UW_QuickPlay_Acknowledgement_C : public UCommonActivatableWidget
{
public:
	...
	void ExecuteUbergraph_W_QuickPlay_Acknowledgement(int32 EntryPoint, class UW_MainMenu_V3_C* CallFunc_GetFirstWidgetOfClass_ReturnValue, class UCommonButtonBase* K2Node_ComponentBoundEvent_Button);
};
