...
// class UW_Loadout_UnitSelect_C*     CallFunc_Array_Get_Item                                          (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UW_Loadout_UnitSelect_C::UpdateSelectedUnit(class UW_Loadout_UnitSelect_Option_C* DropdownOptionWidget, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, class AReadyOrNotGameState* CallFunc_GetReadyOrNotGameState_ReturnValue, TArray<class UW_Loadout_UnitSelect_C*>& CallFunc_GetAllWidgetsOfClass_FoundWidgets, class UW_Loadout_UnitSelect_C* CallFunc_Array_Get_Item, const class FString& CallFunc_GetActiveSwatMemberLabel_ReturnValue, bool CallFunc_NotEqual_ObjectObject_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue)
{
	...
	Params::UW_Loadout_UnitSelect_C_UpdateSelectedUnit_Params Parms{};
...
// class UW_Loadout_UnitSelect_Option_C*CallFunc_Map_Find_Value                                          (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// class UW_Loadout_UnitSelect_Option_C*CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                               bFirstIndex                                                      (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               Temp_bool_Variable                                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AReadyOrNotPlayerState*      Temp_object_Variable                                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// int32                              Temp_int_Variable                                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class EEquippingSwat          Temp_byte_Variable                                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UWorld*                      CallFunc_GetWorldBP_ReturnValue                                  (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class AReadyOrNotPlayerState*      CallFunc_GetLocalPlayerState_ReturnValue                         (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class AReadyOrNotPlayerState*      K2Node_Select_Default_1                                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// struct FST_EquippingUnit           K2Node_MakeStruct_ST_EquippingUnit                               (ZeroConstructor, HasGetValueTypeHash)
// int32                              CallFunc_Array_AddUnique_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UW_Loadout_UnitSelect_Option_C*K2Node_CustomEvent_TriggeringButton                              (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
