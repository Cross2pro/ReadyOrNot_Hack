...
struct UW_MunitionsOverviewSlot_Element_C_AddNewImage_Params
{
public:
	...
	class UImage*                                CallFunc_SpawnObject_ReturnValue;                  // 0x10(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
