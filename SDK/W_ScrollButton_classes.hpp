...
class UW_ScrollButton_C : public UCommonButtonImplementation
{
public:
	...
	class UCommonTextBlock*                      Txt_ButtonLabel;                                   // 0x15F8(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	uint8                                        Pad_2B16[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FString                                TruncatedCharacters;                               // 0x1B28(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
	...
	void Initialize(FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UWidgetSwitcherSlot* CallFunc_SlotAsWidgetSwitcherSlot_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UWidgetSwitcherSlot* CallFunc_SlotAsWidgetSwitcherSlot_ReturnValue_1);
	void Enable(bool Enable);
	void SetBackgroundTint(const struct FLinearColor& InBackgroundColor);
	void SetButtonText(class FText Text, TScriptInterface<class IModioUIHasTextWidget> K2Node_DynamicCast_AsModio_UIHas_Text_Widget, bool K2Node_DynamicCast_bSuccess, bool CallFunc_TextIsEmpty_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue);
