...
struct UMagOut_C_Received_Notify_Params
{
public:
	...
	class ABaseMagazineWeapon*                   K2Node_DynamicCast_AsBase_Magazine_Weapon;         // 0x50(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
