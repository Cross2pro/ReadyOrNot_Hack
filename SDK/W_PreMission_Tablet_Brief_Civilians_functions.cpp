...
class UClass* UW_PreMission_Tablet_Brief_Civilians_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("W_PreMission_Tablet_Brief_Civilians_C");

	return Clss;
}


// W_PreMission_Tablet_Brief_Civilians_C W_PreMission_Tablet_Brief_Civilians.Default__W_PreMission_Tablet_Brief_Civilians_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UW_PreMission_Tablet_Brief_Civilians_C* UW_PreMission_Tablet_Brief_Civilians_C::GetDefaultObj()
{
	static class UW_PreMission_Tablet_Brief_Civilians_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UW_PreMission_Tablet_Brief_Civilians_C*>(UW_PreMission_Tablet_Brief_Civilians_C::StaticClass()->DefaultObject);
...
struct FEventReply UW_PreMission_Tablet_Brief_Civilians_C::OnAnalogValueChanged(const struct FGeometry& MyGeometry, const struct FAnalogInputEvent& InAnalogInputEvent, float CallFunc_GetAnalogValue_ReturnValue, float CallFunc_GetScrollOffsetOfEnd_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_1, double CallFunc_Abs_ReturnValue, float CallFunc_GetScrollOffsetOfEnd_ReturnValue_1, bool CallFunc_IsAnalogValueOutsideDeadZone_ReturnValue, float CallFunc_GetScrollOffset_ReturnValue, float CallFunc_GetScrollOffset_ReturnValue_1, bool CallFunc_Less_DoubleDouble_ReturnValue, bool CallFunc_Less_DoubleDouble_ReturnValue_1, float CallFunc_GetScrollOffset_ReturnValue_2, const struct FKeyEvent& CallFunc_GetKeyEventFromAnalogInputEvent_ReturnValue, double CallFunc_Add_DoubleDouble_ReturnValue, const struct FKey& CallFunc_GetKey_ReturnValue, bool CallFunc_EqualEqual_KeyKey_ReturnValue, const struct FEventReply& CallFunc_Unhandled_ReturnValue, const struct FEventReply& CallFunc_Handled_ReturnValue, double CallFunc_Abs_A_ImplicitCast, double CallFunc_Multiply_DoubleDouble_A_ImplicitCast, float CallFunc_IsAnalogValueOutsideDeadZone_Magnitude_ImplicitCast, double CallFunc_Less_DoubleDouble_A_ImplicitCast, double CallFunc_Less_DoubleDouble_B_ImplicitCast, double CallFunc_Less_DoubleDouble_A_ImplicitCast_1, double CallFunc_Add_DoubleDouble_A_ImplicitCast, float CallFunc_SetScrollOffset_NewScrollOffset_ImplicitCast)
{
	...
	Params::UW_PreMission_Tablet_Brief_Civilians_C_OnAnalogValueChanged_Params Parms{};
...
class UWidget* UW_PreMission_Tablet_Brief_Civilians_C::BP_GetDesiredFocusTarget()
{
	static class UFunction* Func = nullptr;
	...
	Params::UW_PreMission_Tablet_Brief_Civilians_C_BP_GetDesiredFocusTarget_Params Parms{};
...
void UW_PreMission_Tablet_Brief_Civilians_C::PopulateCivilians(int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, class UW_PreMission_Tablet_Brief_SubjectListItem_C* CallFunc_Create_ReturnValue, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue, const struct FCharacterBio& CallFunc_Array_Get_Item, bool CallFunc_Array_IsValidIndex_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, const struct FMargin& K2Node_MakeStruct_Margin)
{
	static class UFunction* Func = nullptr;
	...
	Params::UW_PreMission_Tablet_Brief_Civilians_C_PopulateCivilians_Params Parms{};
...
// Function W_PreMission_Tablet_Brief_Civilians.W_PreMission_Tablet_Brief_Civilians_C.OnEntriesPopulated__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:

void UW_PreMission_Tablet_Brief_Civilians_C::OnEntriesPopulated__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("W_PreMission_Tablet_Brief_Civilians_C", "OnEntriesPopulated__DelegateSignature");
...
// Function W_PreMission_Tablet_Brief_Civilians.W_PreMission_Tablet_Brief_Civilians_C.OnNoEntries__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:

void UW_PreMission_Tablet_Brief_Civilians_C::OnNoEntries__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("W_PreMission_Tablet_Brief_Civilians_C", "OnNoEntries__DelegateSignature");
