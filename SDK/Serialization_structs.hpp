...
public:
	...
	uint8                                        Pad_716[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_719[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FSoftClassPath                        ClassPath;                                         // 0x80(0x20)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                       ObjectPath;                                        // 0xA0(0x20)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_730[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_73A[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_76A[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_775[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_78A[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FStructSerializerObjectTestStruct     Objects;                                           // 0x38(0xC0)(NativeAccessSpecifierPublic)
	uint8                                        Pad_78C[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FStructSerializerBuiltinTestStruct    Builtins;                                          // 0x100(0xD0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStructSerializerArrayTestStruct      Arrays;                                            // 0x1D0(0x60)(NativeAccessSpecifierPublic)
	struct FStructSerializerMapTestStruct        Maps;                                              // 0x230(0x140)(NativeAccessSpecifierPublic)
	struct FStructSerializerSetTestStruct        Sets;                                              // 0x370(0x140)(NativeAccessSpecifierPublic)
	struct FStructSerializerLWCTypesTest         LWCTypes;                                          // 0x4B0(0x360)(NativeAccessSpecifierPublic)
};
