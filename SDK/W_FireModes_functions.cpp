...
// class UW_FireMode_C*               K2Node_DynamicCast_AsW_Fire_Mode                                 (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UW_FireModes_C::SetFireMode(enum class EFireMode NewFireMode, bool K2Node_SwitchEnum_CmpSuccess, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, float CallFunc_K2_SetTimerDelegate_Time_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
// class ABaseWeapon*                 K2Node_CustomEvent_NewWeapon                                     (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
