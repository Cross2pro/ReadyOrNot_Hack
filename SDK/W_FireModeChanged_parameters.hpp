...
struct UW_FireModeChanged_C_ExecuteUbergraph_W_FireModeChanged_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_288E[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UW_MagazineAmmoCheck_C*>        CallFunc_GetAllWidgetsOfClass_FoundWidgets;        // 0x8(0x10)(ReferenceParm, ContainsInstancedReference)
	...
	class UW_MagazineAmmoCheck_C*                CallFunc_Array_Get_Item;                           // 0x30(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class ABaseWeapon*                           K2Node_DynamicCast_AsBase_Weapon;                  // 0x58(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_28E3[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UW_FireModeChanged_C*>          CallFunc_GetAllWidgetsOfClass_FoundWidgets_1;      // 0x68(0x10)(ReferenceParm, ContainsInstancedReference)
	...
	class UW_FireModeChanged_C*                  CallFunc_Array_Get_Item_1;                         // 0x80(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
