...
public:
	...
	class UVerticalBox*                          PopulateBox;                                       // 0x2C8(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FMargin                               ObjectiveMargins;                                  // 0x2D0(0x10)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	TArray<class UClass*>                        PreviewObjectives;                                 // 0x2E0(0x10)(Edit, BlueprintVisible, ExposeOnSpawn)
