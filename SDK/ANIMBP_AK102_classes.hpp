...
public:
	...
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;               // 0x4F0(0x20)(None)
	struct FAnimNode_Slot                        AnimGraphNode_Slot;                                // 0x510(0x48)(None)
