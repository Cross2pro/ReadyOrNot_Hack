...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                               CallFunc_ShowQuitButton_ReturnValue                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_ShowReturnButton_ReturnValue                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_ShowRestartButton_ReturnValue                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_ShowCreditsButton_Show                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_MissionEnd_C::Show_Footer_Options(bool CallFunc_ShowQuitButton_ReturnValue, bool CallFunc_ShowReturnButton_ReturnValue, bool CallFunc_ShowRestartButton_ReturnValue, bool CallFunc_ShowCreditsButton_Show)
{
	static class UFunction* Func = nullptr;
	...
	Params::UW_MissionEnd_C_Show_Footer_Options_Params Parms{};
...
// class FString                      CallFunc_GetCurrentLevelNameForLookupTable_ReturnValue           (ZeroConstructor, HasGetValueTypeHash)
...
// class UW_RosterReview_C*           CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsCommanderMode_ReturnValue_1                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UW_Credits_C*                CallFunc_Create_ReturnValue_1                                    (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
