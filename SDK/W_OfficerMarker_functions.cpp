...
// struct FLinearColor                CallFunc_Get_Player_State_Team_Color_LinearColor                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FSlateColor                 CallFunc_Get_Player_State_Team_Color_SlateColor                  (None)
...
void UW_OfficerMarker_C::SetByPlayerState(class AReadyOrNotPlayerState* PlayerState, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FLinearColor& CallFunc_Get_Player_State_Team_Color_LinearColor, const struct FSlateColor& CallFunc_Get_Player_State_Team_Color_SlateColor, int32 CallFunc_GetPlanningPlayerNumber_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::UW_OfficerMarker_C_SetByPlayerState_Params Parms{};

	Parms.PlayerState = PlayerState;
	Parms.K2Node_CreateDelegate_OutputDelegate = K2Node_CreateDelegate_OutputDelegate;
	Parms.CallFunc_Get_Player_State_Team_Color_LinearColor = CallFunc_Get_Player_State_Team_Color_LinearColor;
	Parms.CallFunc_Get_Player_State_Team_Color_SlateColor = CallFunc_Get_Player_State_Team_Color_SlateColor;
...
// FDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_GetNumber_ReturnValue                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UW_OfficerMarker_C::SetByProxy(class UCharacterProxy* Character, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, int32 CallFunc_GetNumber_ReturnValue, enum class ETeamType CallFunc_GetTeam_ReturnValue, const struct FLinearColor& CallFunc_GetPlayerTeamColor_LinearColor, const struct FSlateColor& CallFunc_GetPlayerTeamColor_SlateColor, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::UW_OfficerMarker_C_SetByProxy_Params Parms{};

	Parms.Character = Character;
	Parms.K2Node_CreateDelegate_OutputDelegate = K2Node_CreateDelegate_OutputDelegate;
	Parms.CallFunc_GetNumber_ReturnValue = CallFunc_GetNumber_ReturnValue;
...
void UW_OfficerMarker_C::OnPlanningTeamUpdated(enum class EPlanningLineTeam Team)
{
	static class UFunction* Func = nullptr;
	...
	Params::UW_OfficerMarker_C_OnPlanningTeamUpdated_Params Parms{};
...
void UW_OfficerMarker_C::ExecuteUbergraph_W_OfficerMarker(int32 EntryPoint, bool K2Node_Event_IsDesignTime, const struct FGeometry& K2Node_Event_MyGeometry, const struct FPointerEvent& K2Node_Event_MouseEvent_1, const struct FPointerEvent& K2Node_Event_MouseEvent, enum class EPlanningLineTeam K2Node_CustomEvent_Team, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UW_OfficerMarker_C*          TriggeringMarker                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
