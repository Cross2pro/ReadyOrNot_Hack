...
public:
	...
	class UCommonTextBlock*                      Txt_Dialogue;                                      // 0x2D0(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class FText                                  SpeakerName;                                       // 0x2E8(0x18)(Edit, BlueprintVisible, ExposeOnSpawn)
	class FText                                  Dialogue;                                          // 0x300(0x18)(Edit, BlueprintVisible, ExposeOnSpawn)
	class FText                                  Timestamp;                                         // 0x318(0x18)(Edit, BlueprintVisible, ExposeOnSpawn)
	FMulticastInlineDelegateProperty_            TranscriptEntryClicked;                            // 0x330(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	double                                       EntryID;                                           // 0x340(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	class FText                                  SpeakerTitle;                                      // 0x348(0x18)(Edit, BlueprintVisible, ExposeOnSpawn)
