...
struct FSavedLoadout UW_Loadout_PresetDropdown_C::GetLoadoutPreset(const class FString& Name, class AReadyOrNotGameState* CallFunc_GetReadyOrNotGameState_ReturnValue, const struct FSavedLoadout& CallFunc_GetPreset_ReturnValue)
{
	...
	Params::UW_Loadout_PresetDropdown_C_GetLoadoutPreset_Params Parms{};
...
void UW_Loadout_PresetDropdown_C::CustomizationPresetApplied(const class FString& Name)
{
	static class UFunction* Func = nullptr;
	...
	Params::UW_Loadout_PresetDropdown_C_CustomizationPresetApplied_Params Parms{};
...
// struct FSavedLoadout               CallFunc_GetLoadoutPreset_ReturnValue                            (None)
...
void UW_Loadout_PresetDropdown_C::ExecuteUbergraph_W_Loadout_PresetDropdown(int32 EntryPoint, class UW_Button_C* K2Node_ComponentBoundEvent_Button, bool CallFunc_Not_PreBool_ReturnValue, const class FString& K2Node_ComponentBoundEvent_OptionID_3, bool CallFunc_EqualEqual_StrStr_ReturnValue, bool CallFunc_EqualEqual_StrStr_ReturnValue_1, bool CallFunc_IsEmpty_ReturnValue, const class FString& K2Node_ComponentBoundEvent_OptionID_2, class FName K2Node_Event_OptionNameID, bool CallFunc_IsEmpty_ReturnValue_1, TMap<enum class EItemCategory, class UClass*> K2Node_Event_ItemCategory, const class FString& CallFunc_Concat_StrStr_ReturnValue, class AReadyOrNotGameState* CallFunc_GetReadyOrNotGameState_ReturnValue, const class FString& K2Node_CustomEvent_Name_1, const struct FSavedLoadout& K2Node_CustomEvent_Loadout, const class FString& CallFunc_Concat_StrStr_ReturnValue_1, const struct FSavedLoadout& K2Node_Event_ActiveLoadout, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const class FString& K2Node_ComponentBoundEvent_OptionID_1, const struct FSavedLoadout& CallFunc_GetLoadoutPreset_ReturnValue, class UW_Dropdown_C* K2Node_ComponentBoundEvent_TriggeringDropdown, const class FString& K2Node_ComponentBoundEvent_OptionID, class AReadyOrNotGameState* CallFunc_GetReadyOrNotGameState_ReturnValue_1, class AReadyOrNotGameState* CallFunc_GetReadyOrNotGameState_ReturnValue_2, class FText CallFunc_GetCurrentPresetDisplayName_ReturnValue, class AReadyOrNotGameState* CallFunc_GetReadyOrNotGameState_ReturnValue_3, class AReadyOrNotGameState* CallFunc_GetReadyOrNotGameState_ReturnValue_4, const class FString& K2Node_CustomEvent_Name, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2)
{
	...
	Parms.CallFunc_GetLoadoutPreset_ReturnValue = CallFunc_GetLoadoutPreset_ReturnValue;
...
void UW_Loadout_PresetDropdown_C::OnCustomizationPresetHovered__DelegateSignature(const class FString& Name)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("W_Loadout_PresetDropdown_C", "OnCustomizationPresetHovered__DelegateSignature");

	Params::UW_Loadout_PresetDropdown_C_OnCustomizationPresetHovered__DelegateSignature_Params Parms{};
...
void UW_Loadout_PresetDropdown_C::OnLoadoutPresetHovered__DelegateSignature(const struct FSavedLoadout& SavedLoadout)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("W_Loadout_PresetDropdown_C", "OnLoadoutPresetHovered__DelegateSignature");

	Params::UW_Loadout_PresetDropdown_C_OnLoadoutPresetHovered__DelegateSignature_Params Parms{};
