...
public:
	...
	FDelegateProperty_                           Callback;                                          // 0xE0(0x10)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class UModioSubsystem*                       Target;                                            // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	FDelegateProperty_                           Callback;                                          // 0xE8(0x10)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1374[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
